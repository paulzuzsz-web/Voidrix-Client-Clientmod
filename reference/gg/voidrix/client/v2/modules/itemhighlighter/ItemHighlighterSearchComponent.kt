...
public class ItemHighlighterSearchComponent(horizontalSizing: Sizing = Sizing.Companion.fill(), verticalSizing: Sizing = Sizing.Companion.content()) : FlowLayout(
   ...
   @JvmStatic
   fun `_init_$addItem`(`this$0`: ItemHighlighterSearchComponent, searchField: VoidrixInputField, id: Identifier, root: ParentUIComponent) {
   ...
   @JvmStatic
   fun `_init_$openDropdown`(`this$0`: ItemHighlighterSearchComponent, searchField: VoidrixInputField) {
      `this$0`.closeDropdown()
