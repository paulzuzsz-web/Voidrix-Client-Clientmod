...
@SourceDebugExtension(["SMAP\nMarqueeState.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MarqueeState.kt\ngg/voidrix/client/v2/modules/spotify/MarqueeState\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,60:1\n1#2:61\n*E\n"])
public object MarqueeState {
   private const val PIXELS_PER_SECOND: Double = 15.0
   private const val PAUSE_MS: Long = 1500L
   private final val entries: ConcurrentHashMap<String, gg.voidrix.client.v2.modules.spotify.MarqueeState.Entry> = ConcurrentHashMap()
   ...
   private data class Entry(text: String, startAt: Long) {
      ...
      public fun copy(text: String = this.text, startAt: Long = this.startAt): gg.voidrix.client.v2.modules.spotify.MarqueeState.Entry {
