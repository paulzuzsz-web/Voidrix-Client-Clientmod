...
public class ItemCounterListComponent : FlowLayout(Sizing.Companion.fill(), Sizing.Companion.content(), Algorithm.VERTICAL) {
   ...
   @SourceDebugExtension(["SMAP\nItemCounterListComponent.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ItemCounterListComponent.kt\ngg/voidrix/client/v2/modules/itemcounter/ItemCounterListComponent$ItemCounterListEntry\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,251:1\n1#2:252\n*E\n"])
   public inner class ItemCounterListEntry(itemCounterDto: ItemCounterDto) : FlowLayout(Sizing.Companion.fill(), Sizing.Companion.content(), Algorithm.VERTICAL) {
      ...
      public final val collapsible: VoidrixCollapsibleContainer
      public final val collapsibleChild: FlowLayout

      public final var scaleSlider: VoidrixSliderWithInput
         internal set
      ...
      init {
         ...
         val var14: VoidrixSliderWithInput = VoidrixSliderWithInput(0.5, 3.0, this.itemCounterDto.scale, 1.0, 0.01, false, 0, 0, 0, 0.0F, 0.0F, 2016, null)
      ...
      private fun buildBackgroundLine(): V3ValueLine {
         ...
         if (bg.getType().getHasColor()) {
            val swatch: V3ColorSwatch = V3ColorSwatch(VoidrixColorPickerKt.toJavaColor(bg.getColor().getColor()), false, 0, 6, null)
            swatch.onChanged().subscribe({ color: Color ->
               `$bg`.getColor().setColor(gg.voidrix.owolib.owo.ui.core.Color.Companion.ofArgb(color.getRGB()))
            })
      ...
      private fun buildPaddingSliders(): FlowLayout {
         ...
         var var5: VoidrixSliderWithInput = VoidrixSliderWithInput(0.0, 20.0, this.itemCounterDto.paddingWidth, 4.0, 1.0, false, 0, 0, 0, 0.0F, 0.0F, 1760, null)
         ...
         var5 = VoidrixSliderWithInput(0.0, 20.0, this.itemCounterDto.paddingHeight, 4.0, 1.0, false, 0, 0, 0, 0.0F, 0.0F, 1760, null)
         var5.onChanged().subscribe({ it: Double ->
      ...
      private fun resetComponents() {
         ...
         val var4: VoidrixSliderWithInput = VoidrixSliderWithInput(0.5, 3.0, this.itemCounterDto.scale, 1.0, 0.01, false, 0, 0, 0, 0.0F, 0.0F, 2016, null)
