...
@SourceDebugExtension(["SMAP\nKeystrokePresets.kt\nKotlin\n*S Kotlin\n*F\n+ 1 KeystrokePresets.kt\ngg/voidrix/client/v2/modules/keystrokes/KeystrokePreset\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,99:1\n1563#2:100\n1634#2,3:101\n*S KotlinDebug\n*F\n+ 1 KeystrokePresets.kt\ngg/voidrix/client/v2/modules/keystrokes/KeystrokePreset\n*L\n27#1:100\n27#1:101,3\n*E\n"])
public data class KeystrokePreset(id: String, displayName: String, keys: List<gg.voidrix.client.v2.modules.keystrokes.KeystrokePreset.PresetEntry>) {
   public final val id: String
   public final val displayName: String
   public final val keys: List<gg.voidrix.client.v2.modules.keystrokes.KeystrokePreset.PresetEntry>
   ...
   public operator fun component3(): List<gg.voidrix.client.v2.modules.keystrokes.KeystrokePreset.PresetEntry> {
      return this.keys
   }
   ...
   public fun copy(
      ...
      keys: List<gg.voidrix.client.v2.modules.keystrokes.KeystrokePreset.PresetEntry> = this.keys
   ): KeystrokePreset {
   ...
   public data class PresetEntry(cellX: Int, cellY: Int, widthCells: Int, heightCells: Int, keyName: String) {
      ...
      ): gg.voidrix.client.v2.modules.keystrokes.KeystrokePreset.PresetEntry {
