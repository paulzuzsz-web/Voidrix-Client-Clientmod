...
import gg.voidrix.client.v2.modules.keystrokes.Keystrokes.GridKeyWrapper
      ...
      if (this.lastScreenW <= 0) {
         ...
         if (this.isResizing) {
            ...
            MCLogger.getLogger("KeystrokeResize")
               ...
               Keystrokes.INSTANCE.setHudScale$voidrix_client(newScale)
            return true
