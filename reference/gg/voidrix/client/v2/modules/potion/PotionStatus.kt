package gg.voidrix.client.v2.modules.potion

import com.mojang.blaze3d.platform.Window
import gg.voidrix.client.v2.mixin.potion.InGameHudAccessor
import gg.voidrix.compat.client.MCLogger
import gg.voidrix.compat.client.PeriodicLogManager
import gg.voidrix.compat.scale.IWindowScaleExt
import gg.voidrix.compat.scale.ScaledResolution
...
import gg.voidrix.ui.api.hud.Alignment
...
public object PotionStatus : AbstractHud("Potion Status", false, true, false, 10), IContentBackground {
   ...
   @SourceDebugExtension(["SMAP\nPotionStatus.kt\nKotlin\n*S Kotlin\n*F\n+ 1 PotionStatus.kt\ngg/voidrix/client/v2/modules/potion/PotionStatus$PotionStatusComponent\n+ 2 MCLogger.kt\ngg/voidrix/compat/client/MCLoggerKt\n+ 3 MCClient.kt\ngg/voidrix/compat/client/MCClient\n*L\n1#1,422:1\n189#2,4:423\n194#2:428\n40#3:427\n40#3:429\n40#3:430\n*S KotlinDebug\n*F\n+ 1 PotionStatus.kt\ngg/voidrix/client/v2/modules/potion/PotionStatus$PotionStatusComponent\n*L\n246#1:423,4\n246#1:428\n247#1:427\n291#1:429\n292#1:430\n*E\n"])
   public class PotionStatusComponent(wrapper: FlowLayout,
      ...
      public open fun draw(context: OwoUIGraphics, mouseX: Int, mouseY: Int, partialTicks: Float, delta: Float) {
         val `$this$voidrixDebugEvery_u24default$iv`: Logger = this.log
         if (MCLogger.IS_DEBUG && PeriodicLogManager.INSTANCE.shouldLog("PotionStatus.draw", 2000L)) {
            ...
            val var24: Double = var22.getVoidrix_mcScaleFactor()
            val var10001: Int = window.getGuiScale()
            val var10002: Int = wsm.getCurrentScale()
            val var10003: Double = wsm.getScaleDiff()
            val var10004: ScaledResolution = var22.getVoidrix_scaledResolution()
            val var30: Int = if (var10004 != null) var10004.getScaleFactor() else null
            val var10005: ScaledResolution = wsm.getScaledResolution()
            `$this$voidrixDebugEvery_u24default$iv`.info(
               "PotionStatus DEBUG: voidrix_mcScaleFactor=$var24, window.guiScale=$var10001, DEFAULT_SCALE=3, currentScale=$var10002, scaleDiff=$var10003, voidrix_scaledResolution=$var30, scaledResolution=${if (var10005
                     != null)
