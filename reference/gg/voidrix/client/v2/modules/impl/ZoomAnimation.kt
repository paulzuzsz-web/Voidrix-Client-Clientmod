...
public class ZoomAnimation(start: Float, end: Float, dur: Duration) {
   ...
   public final var easing: gg.voidrix.client.v2.modules.impl.ZoomAnimation.Easing
      internal set
   ...
   public constructor(start: Float, end: Float, duration: Duration, easing: gg.voidrix.client.v2.modules.impl.ZoomAnimation.Easing) : this(start, end, duration) {
      this.easing = easing
   }
