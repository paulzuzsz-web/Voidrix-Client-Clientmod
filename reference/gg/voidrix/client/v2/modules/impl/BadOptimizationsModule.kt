...
import gg.voidrix.compat.icon.atlas.IconAtlasManager
import gg.voidrix.compat.render.BadOptimizationsManager
import gg.voidrix.compat.render.IBadOptimizationsSettings
import gg.voidrix.compat.render.VoidrixBindSkip
import gg.voidrix.compat.skin.atlas.SkinAtlasManager
...
import gg.voidrix.ui.api.value.ValueJsonKt
...
public object BadOptimizationsModule : Module("Bad Optimizations", ModuleCategory.QUALITY_OF_LIFE, false, false, false, 20), IBadOptimizationsSettings {
   ...
   private final val skinAtlasToggle: gg.voidrix.client.v2.modules.impl.BadOptimizationsModule.DescribedToggle =
      BadOptimizationsModule.DescribedToggle(true, "Skin Atlas")
      private final val iconAtlasToggle: gg.voidrix.client.v2.modules.impl.BadOptimizationsModule.DescribedToggle =
      BadOptimizationsModule.DescribedToggle(true, "Icon Atlas")
      private final val bindSkipToggle: gg.voidrix.client.v2.modules.impl.BadOptimizationsModule.DescribedToggle =
   ...
   private fun flip(toggle: gg.voidrix.client.v2.modules.impl.BadOptimizationsModule.DescribedToggle): Boolean {
   ...
   private fun applyFlags() {
      ...
      VoidrixBindSkip.setEnabled(this.isEnabled() && this.renderPassBindSkip)
   }
   ...
   private class DescribedToggle(value: Boolean, displayName: String) : Value(value, displayName, null, { it: Boolean ->
      ...
      public open fun buildElement(parent: ParentUIComponent, updateLabel: () -> Unit): UIComponent {
         ...
         // 0c: new gg/voidrix/ui/components/voidrix/VoidrixCheckbox
         // 0f: dup
         // 10: fconst_0
         // 11: bipush 1
         // 12: aconst_null
         // 13: invokespecial gg/voidrix/ui/components/voidrix/VoidrixCheckbox.<init> (FILkotlin/jvm/internal/DefaultConstructorMarker;)V
         // 16: astore 3
         // 17: aload 3
         // 18: astore 4
         // 1a: bipush 0
         ...
         // 1d: aload 4
         // 1f: aload 0
         // 20: invokevirtual gg/voidrix/client/v2/modules/impl/BadOptimizationsModule$DescribedToggle.getValue ()Ljava/lang/Object;
         // 23: checkcast java/lang/Boolean
         // 26: invokevirtual java/lang/Boolean.booleanValue ()Z
         // 29: invokevirtual gg/voidrix/ui/components/voidrix/VoidrixCheckbox.checked (Z)Lgg/voidrix/owolib/owo/ui/component/SmallCheckboxComponent;
         // 2c: pop
         // 2d: aload 4
         // 2f: invokevirtual gg/voidrix/ui/components/voidrix/VoidrixCheckbox.onChanged ()Lgg/voidrix/owolib/owo/util/EventSource;
         // 32: new gg/voidrix/client/v2/modules/impl/BadOptimizationsModule$DescribedToggle$buildElement$1$1
         // 35: dup
         // 36: aload 0
         // 37: invokespecial gg/voidrix/client/v2/modules/impl/BadOptimizationsModule$DescribedToggle$buildElement$1$1.<init> (Lgg/voidrix/client/v2/modules/impl/BadOptimizationsModule$DescribedToggle;)V
         // 3a: invokevirtual gg/voidrix/owolib/owo/util/EventSource.subscribe (Ljava/lang/Object;)Lgg/voidrix/owolib/owo/util/EventSource$Subscription;
         // 3d: pop
         // 3e: aload 4
         // 40: getstatic gg/voidrix/owolib/owo/ui/core/Insets.Companion Lgg/voidrix/owolib/owo/ui/core/Insets$Companion;
         // 43: bipush 1
         // 44: invokevirtual gg/voidrix/owolib/owo/ui/core/Insets$Companion.of (I)Lgg/voidrix/owolib/owo/ui/core/Insets;
         // 47: invokevirtual gg/voidrix/ui/components/voidrix/VoidrixCheckbox.margins (Lgg/voidrix/owolib/owo/ui/core/Insets;)Lgg/voidrix/owolib/owo/ui/base/BaseUIComponent;
         // 4a: pop
         // 4b: nop
         // 4c: aload 3
         // 4d: checkcast gg/voidrix/owolib/owo/ui/core/UIComponent
         // 50: areturn
      }
      ...
      public open fun buildCustomLine(verticalWrapper: FlowLayout): Boolean {
         ...
         val key: java.lang.String = "voidrix.ui.modules.value.${this.getName()}.description"
