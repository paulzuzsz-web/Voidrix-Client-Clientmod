...
public object RecursivePackDiscovery {
   ...
   public fun discoverNestedPacks(root: Path, maxDepth: Int = 10): List<gg.voidrix.client.v2.modules.impl.RecursivePackDiscovery.DiscoveredPack> {
      if (!Files.isDirectory(root)) {
         ...
         Files.walkFileTree(root, SetsKt.setOf(FileVisitOption.FOLLOW_LINKS), maxDepth, object : SimpleFileVisitor<Path> {
            ...
            public open fun visitFileFailed(file: Path, exc: IOException): FileVisitResult {
               MCLoggerKt.voidrixDebugLog(RecursivePackDiscovery.logger, "packs", "Failed to access: $file")
               return FileVisitResult.CONTINUE
            }
         })
         if (!packs.isEmpty()) {
            MCLoggerKt.voidrixDebugLog(logger, "packs", "Discovered ${packs.size()} nested resource pack(s) in $root")
         }
   ...
   public data class DiscoveredPack(path: Path, type: gg.voidrix.client.v2.modules.impl.RecursivePackDiscovery.DiscoveredPackType) {
      public final val path: Path
      public final val type: gg.voidrix.client.v2.modules.impl.RecursivePackDiscovery.DiscoveredPackType
      ...
      public operator fun component2(): gg.voidrix.client.v2.modules.impl.RecursivePackDiscovery.DiscoveredPackType {
         return this.type
      }

      public fun copy(path: Path = this.path, type: gg.voidrix.client.v2.modules.impl.RecursivePackDiscovery.DiscoveredPackType = this.type): gg.voidrix.client.v2.modules.impl.RecursivePackDiscovery.DiscoveredPack {
