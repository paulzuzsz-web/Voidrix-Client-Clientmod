...
import gg.voidrix.compat.icon.IconResolver
import gg.voidrix.compat.icon.VoidrixPlayerCache
import gg.voidrix.compat.icon.IconResolver.IconResult
import gg.voidrix.compat.nametag.NameTagIconEvent
import gg.voidrix.compat.nametag.NameTagIconEventKt
import gg.voidrix.compat.tablist.TabListIconEvent
import gg.voidrix.compat.tablist.TabListIconEventKt
...
public object IconModule : Module("Icon", ModuleCategory.VISUAL, false, true, false, 20) {
   ...
   @Category(name = "Branding")
   @NotNull
   public final val position: gg.voidrix.client.v2.modules.impl.IconModule.BrandingPosition by ValueApiKt.enum$default(
   ...
   @NotNull
   public final val iconPosition: gg.voidrix.client.v2.modules.impl.IconModule.IconPosition by ValueApiKt.enum$default(
   ...
   private fun applyTabListIcon(uuid: UUID, event: TabListIconEvent) {
      var var10000: VoidrixUserMinimal = VoidrixPlayerCache.INSTANCE.getCached(uuid)
      if (var10000 == null) {
         val var7: java.lang.String = event.getPlayerName()
         var10000 = if (var7 != null) VoidrixPlayerCache.INSTANCE.findCachedByNameInText(var7) else null
         if (var10000 == null) {
            return
         }
      }
