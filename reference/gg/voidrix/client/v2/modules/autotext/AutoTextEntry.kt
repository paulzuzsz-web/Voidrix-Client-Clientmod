...
import gg.voidrix.ui.api.value.KeyValue.KeyWrapper
...
@Serializable
@SourceDebugExtension(["SMAP\nAutoTextEntry.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AutoTextEntry.kt\ngg/voidrix/client/v2/modules/autotext/AutoTextEntry\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,23:1\n1563#2:24\n1634#2,3:25\n1563#2:28\n1634#2,3:29\n2746#2,3:32\n*S KotlinDebug\n*F\n+ 1 AutoTextEntry.kt\ngg/voidrix/client/v2/modules/autotext/AutoTextEntry\n*L\n16#1:24\n16#1:25,3\n19#1:28\n19#1:29,3\n21#1:32,3\n*E\n"])
public data class AutoTextEntry(id: String = UUID.randomUUID().toString(),
   ...
   private KSerializer<Object>[] $childSerializers = arrayOf(
      null,
      null,
      ArrayListSerializer(gg.voidrix.ui.api.value.KeyValue.KeyWrapper..serializer.INSTANCE as KSerializer),
      null
   );
