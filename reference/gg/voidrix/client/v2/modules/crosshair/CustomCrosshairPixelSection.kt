...
import gg.voidrix.ui.components.voidrix.VoidrixPixelGridPreviewComponent
...
public class CustomCrosshairPixelSection(initialCells: Map<Pair<Int, Int>, Int>,
   ...
   public final val pixelGrid: VoidrixPixelGridDrawComponent

   init {
      this.onApply = onApply
      this.onBrushColorChange = onBrushColorChange
      this.pixelGrid = VoidrixPixelGridDrawComponent(15, 7)
      this.gap(6)
      ...
      for (var18 in CustomCrosshairPresets.INSTANCE.list) {
         var15.child(VoidrixPixelGridPreviewComponent(var18, 0, 1, { 
            CustomCrosshair.INSTANCE.activateCustom()
            val cells: java.util.Map = VoidrixPixelGridDrawComponent.Companion.parsePresetPattern(`$preset`.getPattern(), `this$0`.pixelGrid.getPixelColorRgb())
   ...
   private fun toolButton(label: String, action: () -> Unit): V3Button {
      val var3: V3Button = V3Button(TextKt.toSmallCaps(label), { var1: VoidrixLabelButton, var2: Double, var4: Double, var6: Int ->
