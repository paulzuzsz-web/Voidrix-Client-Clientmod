package gg.voidrix.client.v2.modules.scoreboard

import gg.voidrix.client.v2.mixin.scoreboard.GuiScoreboardAccessor
import gg.voidrix.client.v2.modules.impl.ClearBackgroundModule
import gg.voidrix.compat.event.ClientEvents
import gg.voidrix.compat.text.VoidrixTextShaderCache
import gg.voidrix.compat.text.VoidrixTextShaderContext
...
public object ScoreboardModule : AbstractHud("Scoreboard", false, true, true, 2), IContentBackground {
   ...
   private fun collectEntries(objective: Any): List<gg.voidrix.client.v2.modules.scoreboard.ScoreboardModule.SidebarEntry> {
      val var10000: Minecraft = Minecraft.getInstance()
   ...
   @SourceDebugExtension(["SMAP\nScoreboardModule.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ScoreboardModule.kt\ngg/voidrix/client/v2/modules/scoreboard/ScoreboardModule$ScoreboardComponent\n+ 2 MCClient.kt\ngg/voidrix/compat/client/MCClient\n+ 3 MCClient.kt\ngg/voidrix/compat/client/MCClientKt\n*L\n1#1,443:1\n127#2:444\n40#2:445\n328#2:449\n40#2:450\n127#2:451\n40#2:452\n942#3:446\n941#3:447\n942#3:448\n942#3:453\n941#3:454\n942#3:455\n*S KotlinDebug\n*F\n+ 1 ScoreboardModule.kt\ngg/voidrix/client/v2/modules/scoreboard/ScoreboardModule$ScoreboardComponent\n*L\n346#1:444\n346#1:445\n364#1:449\n364#1:450\n378#1:451\n378#1:452\n349#1:446\n351#1:447\n354#1:448\n381#1:453\n383#1:454\n386#1:455\n*E\n"])
   public class ScoreboardComponent : FlowLayout(
      ...
      public open fun draw(context: OwoUIGraphics, mouseX: Int, mouseY: Int, partialTicks: Float, delta: Float) {
         ...
         if (objective != null && (!ScoreboardModule.INSTANCE.hideScoreboard || inEditor)) {
            ...
            VoidrixTextShaderCache.setCurrentContext(VoidrixTextShaderContext.SCOREBOARD)
            ...
            try {
               ...
               VoidrixTextShaderCache.setCurrentContext(null)
            }
         } else {
            this.surface(Surface.BLANK)
         }
   ...
   private data class SidebarEntry(name: Component, scoreText: String, scoreWidth: Int) {
      ...
      public fun copy(name: Component = this.name, scoreText: String = this.scoreText, scoreWidth: Int = this.scoreWidth): gg.voidrix.client.v2.modules.scoreboard.ScoreboardModule.SidebarEntry {
