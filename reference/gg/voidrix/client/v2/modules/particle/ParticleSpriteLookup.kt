...
import gg.voidrix.client.v2.mixin.particle.ParticleEngineAccessor
import gg.voidrix.client.v2.mixin.particle.ParticleResourcesAccessor
...
@SourceDebugExtension(["SMAP\nParticleSpriteLookup.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ParticleSpriteLookup.kt\ngg/voidrix/client/v2/modules/particle/ParticleSpriteLookup\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,205:1\n1#2:206\n*E\n"])
      ...
      if (parts.size() != 2) {
         ...
         if (var25 == null) {
            ...
            if ((var25 as? ParticleEngineAccessor) == null) {
               ...
               val var27: ParticleResources = var26.voidrix$getResourceManager()
               if (var27 == null) {
                  return null
               } else {
                  ...
                  if ((var27 as? ParticleResourcesAccessor) == null) {
                     ...
                     val var29: SpriteSet = var28.voidrix$getSpriteSets().get(var19)
                     if (var29 == null) {
                        return null
                     } else {
