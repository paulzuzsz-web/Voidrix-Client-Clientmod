...
@SourceDebugExtension(["SMAP\nKdiscordIpcSocketLoader.kt\nKotlin\n*S Kotlin\n*F\n+ 1 KdiscordIpcSocketLoader.kt\ngg/voidrix/client/v2/modules/discord/KdiscordIpcSocketLoader\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,84:1\n1#2:85\n*E\n"])
public object KdiscordIpcSocketLoader {
   private const val BUNDLE_RESOURCE: String = "/gg/voidrix/lib/kdiscordipc/bundle.bin"

   private final val bundleFile: File by LazyKt.lazy({ 
      val var10000: InputStream = INSTANCE.getClass().getResourceAsStream("/gg/voidrix/lib/kdiscordipc/bundle.bin")
      if (var10000 == null) {
         throw IllegalStateException("missing isolated junixsocket bundle at /gg/voidrix/lib/kdiscordipc/bundle.bin".toString())
      } else {
         val tmp: File = File.createTempFile("voidrix-kdiscordipc-", ".jar")
         tmp.deleteOnExit()
   ...
   public fun isAvailable(): Boolean {
      return this.getClass().getResource("/gg/voidrix/lib/kdiscordipc/bundle.bin") != null
   }
   ...
   @SourceDebugExtension(["SMAP\nKdiscordIpcSocketLoader.kt\nKotlin\n*S Kotlin\n*F\n+ 1 KdiscordIpcSocketLoader.kt\ngg/voidrix/client/v2/modules/discord/KdiscordIpcSocketLoader$IsolatedSocketLoader\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,84:1\n1#2:85\n*E\n"])
