...
import gg.voidrix.compat.path.LauncherPaths
import java.io.File
...
public object DiscordStateFile {
   ...
   private final val discordDir: File by LazyKt.lazy({ 
      val var10000: java.lang.String = System.getProperty("voidrix.meta.dir")
   ...
   public fun writeState(state: String, details: String? = null) {
      ...
      try {
         ...
         val `$this$voidrixDebug$iv`: Json = DiscordStateFileKt.access$getJson$p()
         `$this$voidrixDebug$iv`.getSerializersModule()
         FilesKt.writeText$default(
            var10000, `$this$voidrixDebug$iv`.encodeToString(DiscordEntry.Companion.serializer() as SerializationStrategy, var6), null, 2, null
         )
