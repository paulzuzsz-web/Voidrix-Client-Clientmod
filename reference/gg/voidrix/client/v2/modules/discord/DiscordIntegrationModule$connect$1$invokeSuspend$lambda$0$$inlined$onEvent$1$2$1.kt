...
@DebugMetadata(f = "DiscordIntegrationModule.kt", l = [224], i = [], s = [], n = [], m = "emit", c = "gg.voidrix.client.v2.modules.discord.DiscordIntegrationModule$connect$1$invokeSuspend$lambda$0$$inlined$onEvent$1$2")
