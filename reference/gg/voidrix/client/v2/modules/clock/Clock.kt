...
import gg.voidrix.ui.theme.ThemeModuleKt
...
public object Clock : SingleTextHud("Clock", "HH:mm:ss", null, null, false, false, false, 124) {
   ...
   public open fun buildCustomUi(): (FlowLayout) -> Unit {
      return { settingsPanel: FlowLayout ->
         ...
         var4.setBold(true)
         val collapsible: VoidrixCollapsibleContainer = VoidrixCollapsibleContainer(var4.build() as Component, true, null, null, 12, null)
   ...
   private fun addFormatExample(parent: FlowLayout, pattern: String, dateTime: LocalDateTime) {
      ...
      if (Result.exceptionOrNull_impl/* $VF was: exceptionOrNull-impl */(it) == null) {
         ...
         val var21: MutableComponent = Component.translatable("voidrix.clock.label.invalid_format", Arrays.copyOf(`args$iv`, `args$iv`.length))
         var20 = parent
         var10001 = var10001
         var10002 = var21
      }
