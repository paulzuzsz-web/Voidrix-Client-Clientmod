...
import gg.voidrix.ui.client.gui.render.state.TexturedQuadGuiElementRenderStateDouble
...
public object ChatHeads_v1_21_6 {
   ...
   public fun renderHead_v1_21_6(
      ...
      val textures: PlayerSkin = if ((textGuiElementRenderState as? ChatHeads_v1_21_6.ITextGuiElementRenderStateExt) != null)
         (textGuiElementRenderState as? ChatHeads_v1_21_6.ITextGuiElementRenderStateExt).voidrix_currentSkinTextures
         else
         null
         if (textures != null) {
         var var11: Boolean
         run label77@{
            ...
            if ((glyph as? IDrawnGlyphExt) != null) {
               val var10: Int = var10000.voidrix_charCode
               if (var10 != null) {
   ...
   public interface ITextGuiElementRenderStateExt {
      public var voidrix_currentSkinTextures: PlayerSkin?
         internal final set
   }
}
