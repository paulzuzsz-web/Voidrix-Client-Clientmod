...
internal class `ScreenshotModule$registerCommands$lambda$7$lambda$2$$inlined$argument$1` : Function0<java.lang.String> {
   fun `ScreenshotModule$registerCommands$lambda$7$lambda$2$$inlined$argument$1`(`$builder`: ArgumentCommandBuilder, `$name`: java.lang.String) {
