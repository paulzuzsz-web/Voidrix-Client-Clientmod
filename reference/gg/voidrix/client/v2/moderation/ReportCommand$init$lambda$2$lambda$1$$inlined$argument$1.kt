...
internal class `ReportCommand$init$lambda$2$lambda$1$$inlined$argument$1` : Function0<java.lang.String> {
   fun `ReportCommand$init$lambda$2$lambda$1$$inlined$argument$1`(`$builder`: ArgumentCommandBuilder, `$name`: java.lang.String) {
