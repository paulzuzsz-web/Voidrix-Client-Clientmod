...
internal class `PunishCommand$init$lambda$11$lambda$10$lambda$1$$inlined$argument$1` : Function0<java.lang.String> {
   fun `PunishCommand$init$lambda$11$lambda$10$lambda$1$$inlined$argument$1`(`$builder`: ArgumentCommandBuilder, `$name`: java.lang.String) {
