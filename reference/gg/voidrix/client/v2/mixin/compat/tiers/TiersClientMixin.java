package gg.voidrix.client.v2.mixin.compat.tiers;
...
public abstract class TiersClientMixin {
   ...
   private static KeyMapping voidrix$disableTiersKeyBinding(KeyMapping keyBinding, Operation<KeyMapping> original) {
