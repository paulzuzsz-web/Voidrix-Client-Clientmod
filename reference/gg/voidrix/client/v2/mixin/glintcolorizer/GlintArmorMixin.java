...
public abstract class GlintArmorMixin {
   ...
   private RenderType voidrix$redirectArmorGlint(Operation<RenderType> original) {
      return GlintColorizerModule.isActive() ? VoidrixGlintRenderTypes.armorEntityGlint() : (RenderType)original.call(new Object[0]);
   }
}
