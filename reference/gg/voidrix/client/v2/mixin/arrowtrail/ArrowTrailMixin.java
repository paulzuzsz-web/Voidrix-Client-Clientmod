package gg.voidrix.client.v2.mixin.arrowtrail;

import com.llamalad7.mixinextras.injector.ModifyExpressionValue;
import com.llamalad7.mixinextras.injector.wrapoperation.Operation;
import com.llamalad7.mixinextras.injector.wrapoperation.WrapOperation;
import gg.voidrix.client.v2.modules.arrowtrail.ArrowTrail;
...
public class ArrowTrailMixin {
   ...
   private boolean voidrix$modifyCritCheck(boolean original) {
   ...
   private void voidrix$wrapParticle(Level level, ParticleOptions particle, double x, double y, double z, double dx, double dy, double dz, Operation<Void> original) {
