...
public class DrawContextTextConsumerImplMixin {
   ...
   private void voidrix$setCurrentSkinTextures(GuiRenderState instance, GuiTextRenderState textGuiElementRenderState, Operation<Void> source) {
      PlayerSkin currentSkinTextures = ChatHeads.INSTANCE.getCurrentSkinTextures();
      if (currentSkinTextures != null) {
         ((ChatHeads_v1_21_6.ITextGuiElementRenderStateExt)textGuiElementRenderState).setVoidrix_currentSkinTextures(currentSkinTextures);
      }
