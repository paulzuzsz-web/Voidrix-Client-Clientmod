...
import gg.voidrix.compat.resource.VoidrixTexture
import gg.voidrix.compat.resource.VoidrixTextureMetadata
...
@SourceDebugExtension(["SMAP\nVoidrixTextureDebugScreen.kt\nKotlin\n*S Kotlin\n*F\n+ 1 VoidrixTextureDebugScreen.kt\ngg/voidrix/client/v2/debug/VoidrixTextureDebugScreen\n+ 2 OwoIdentifier.kt\ngg/voidrix/compat/resource/OwoIdentifierKt\n+ 3 MCClient.kt\ngg/voidrix/compat/client/MCClient\n+ 4 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 5 Text.kt\ngg/voidrix/compat/text/TextKt\n*L\n1#1,190:1\n21#2:191\n40#3:192\n1#4:193\n66#5:194\n66#5:195\n66#5:196\n66#5:197\n66#5:198\n66#5:199\n66#5:200\n66#5:201\n66#5:202\n66#5:203\n66#5:204\n66#5:205\n66#5:206\n66#5:207\n66#5:208\n66#5:209\n66#5:210\n66#5:211\n*S KotlinDebug\n*F\n+ 1 VoidrixTextureDebugScreen.kt\ngg/voidrix/client/v2/debug/VoidrixTextureDebugScreen\n*L\n20#1:191\n113#1:192\n117#1:194\n121#1:195\n124#1:196\n128#1:197\n129#1:198\n132#1:199\n134#1:200\n136#1:201\n138#1:202\n139#1:203\n140#1:204\n142#1:205\n144#1:206\n146#1:207\n147#1:208\n148#1:209\n155#1:210\n158#1:211\n*E\n"])
public class VoidrixTextureDebugScreen : BaseOwoScreen(null, 1) {
   ...
   protected open fun createAdapter(): OwoUIAdapter<FlowLayout> {
      return OwoUIAdapter.Companion.create(this as Screen, gg/voidrix/client/v2/debug/VoidrixTextureDebugScreen##Lambda_0_71())
   }
   ...
   protected open fun build(rootComponent: FlowLayout) {
      ...
      val title: LabelComponent = LabelComponent("VoidrixTexture Debug")
      title.shadow(true)
      ...
      content.gap(8)
      content.child(this.sectionLabel("VoidrixTexture Interception Test") as UIComponent)
   ...
   private fun updateVoidrixTextureStatus() {
      ...
      if (var7 is VoidrixTexture) {
         ...
         var var10001: MutableComponent = Component.literal("Texture type: VoidrixTexture (intercepted!)")
         ...
         if ((var7 as VoidrixTexture).isLoaded()) {
         ...
         var10001 = Component.literal("isLoaded: ${(var7 as VoidrixTexture).isLoaded()}")
         ...
         var10001 = Component.literal("Frames: ${(var7 as VoidrixTexture).getFrames().size()}")
         var50.text(var10001 as Component)
         val var14: VoidrixTextureMetadata = (var7 as VoidrixTexture).getVoidrixTextureMetadata()
         ...
         var72 = Component.literal("Status: Fallback (no VoidrixTexture)")
