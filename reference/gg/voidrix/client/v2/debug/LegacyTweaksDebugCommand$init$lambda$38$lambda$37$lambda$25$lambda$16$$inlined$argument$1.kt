...
@SourceDebugExtension(["SMAP\nCommandBuilder.kt\nKotlin\n*S Kotlin\n*F\n+ 1 CommandBuilder.kt\ngg/voidrix/compat/command/CommandBuilder$argument$builder$1\n+ 2 ArgumentTypeUtils.kt\ngg/voidrix/compat/command/ArgumentTypeUtilsKt\n*L\n1#1,445:1\n29#2,13:446\n55#2:459\n*S KotlinDebug\n*F\n+ 1 CommandBuilder.kt\ngg/voidrix/compat/command/CommandBuilder$argument$builder$1\n*L\n133#1:446,13\n133#1:459\n*E\n"])
internal class `LegacyTweaksDebugCommand$init$lambda$38$lambda$37$lambda$25$lambda$16$$inlined$argument$1` : Function1<CommandBuildContext, ArgumentType<?>> {
   @JvmStatic
   public LegacyTweaksDebugCommand$init$lambda$38$lambda$37$lambda$25$lambda$16$$inlined$argument$1 INSTANCE = LegacyTweaksDebugCommand$init$lambda$38$lambda$37$lambda$25$lambda$16$$inlined$argument$1();

   fun invoke(ctx: CommandBuildContext): ArgumentType<*> {
      val var3: KClass = Int::class
      ...
      if (var3 == java.lang.Boolean::class) {
         ...
         if (!(var3 == Component::class)) {
            throw IllegalArgumentException("No argument type mapping for ${(Int::class).getQualifiedName()}")
         }
