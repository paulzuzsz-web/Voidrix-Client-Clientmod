...
internal class `LegacyTweaksDebugCommand$init$lambda$38$lambda$37$lambda$36$$inlined$argument$1` : Function0<java.lang.String> {
   fun `LegacyTweaksDebugCommand$init$lambda$38$lambda$37$lambda$36$$inlined$argument$1`(`$builder`: ArgumentCommandBuilder, `$name`: java.lang.String) {
