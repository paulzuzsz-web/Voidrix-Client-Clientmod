...
import gg.voidrix.client.v2.perf.BatchModelRendering
import gg.voidrix.compat.bugfix.CameraThroughGrass
...
import gg.voidrix.compat.resource.VoidrixTextureUploadQueue
import gg.voidrix.compat.skin.BodyPartTextureRange
import gg.voidrix.compat.skin.SkinDebugPainter
...
public object LegacyTweaksDebugCommand {
                  ...
                  `$this$literal`.literal(
                     ...
                     { $this$literal: LiteralCommandBuilder ->
                        ...
                        `$this$literal`.literal("toggle", { $this$literal: LiteralCommandBuilder ->
                           `$this$literal`.runsSuccess({ $this$runsSuccess: CommandExecutionContext ->
                              VoidrixTextureUploadQueue.INSTANCE.setEnabled(!VoidrixTextureUploadQueue.INSTANCE.getEnabled())
                              val state: java.lang.String = if (VoidrixTextureUploadQueue.INSTANCE.getEnabled()) "§2ON" else "§cOFF"
                              val var10000: ClientCommandSource = `$this$runsSuccess`.getSource() as ClientCommandSource
                        ...
                        `$this$literal`.literal("inline", { $this$literal: LiteralCommandBuilder ->
                           `$this$literal`.runsSuccess({ $this$runsSuccess: CommandExecutionContext ->
                              VoidrixTextureUploadQueue.INSTANCE.setInlineIfOnRenderThread(!VoidrixTextureUploadQueue.INSTANCE.getInlineIfOnRenderThread())
                              val state: java.lang.String = if (VoidrixTextureUploadQueue.INSTANCE.getInlineIfOnRenderThread()) "§2ON" else "§cOFF"
                              val var10000: ClientCommandSource = `$this$runsSuccess`.getSource() as ClientCommandSource
                        ...
                        `$this$literal`.literal("clear", { $this$literal: LiteralCommandBuilder ->
                           `$this$literal`.runsSuccess({ $this$runsSuccess: CommandExecutionContext ->
                              val before: Int = VoidrixTextureUploadQueue.INSTANCE.getPending()
                              VoidrixTextureUploadQueue.INSTANCE.clear()
                              val var10000: ClientCommandSource = `$this$runsSuccess`.getSource() as ClientCommandSource
                        ...
                        `$this$literal`.literal("reset", { $this$literal: LiteralCommandBuilder ->
                           `$this$literal`.runsSuccess({ $this$runsSuccess: CommandExecutionContext ->
                              VoidrixTextureUploadQueue.INSTANCE.setMaxUploadsPerFrame(3)
                              VoidrixTextureUploadQueue.INSTANCE.setMaxUploadMillisPerFrame(4L)
                              VoidrixTextureUploadQueue.INSTANCE.setMinDelayBetweenDrainsMs(0L)
                              VoidrixTextureUploadQueue.INSTANCE.setEnabled(true)
                              VoidrixTextureUploadQueue.INSTANCE.setInlineIfOnRenderThread(true)
                              val var10000: ClientCommandSource = `$this$runsSuccess`.getSource() as ClientCommandSource
   ...
   private fun sendUploadQueueStatus(source: ClientCommandSource) {
      val q: VoidrixTextureUploadQueue = VoidrixTextureUploadQueue.INSTANCE
      var var10001: MutableComponent = Component.literal(
         "§7[Voidrix] UploadQueue: ${if (VoidrixTextureUploadQueue.INSTANCE.getEnabled()) "§2ON" else "§cOFF"} §8| §7pending=§e${q.getPending()}"
      )
