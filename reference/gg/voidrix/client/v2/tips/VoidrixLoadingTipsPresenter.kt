...
@SourceDebugExtension(["SMAP\nVoidrixLoadingTipsPresenter.kt\nKotlin\n*S Kotlin\n*F\n+ 1 VoidrixLoadingTipsPresenter.kt\ngg/voidrix/client/v2/tips/VoidrixLoadingTipsPresenter\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,71:1\n1#2:72\n*E\n"])
public object VoidrixLoadingTipsPresenter {
         ...
         if (tips.isEmpty()) {
            ...
            if (currentTipLine == null) {
               ...
               run label49@{
                  ...
                  var10000 = VoidrixTipsTranslationLoader.titleOrDefault(MapsKt.emptyMap())
               }
   ...
   private fun resolveTipList(gameDir: File): List<String> {
      if (tipList != null) {
         ...
         val translations: java.util.Map = VoidrixTipsTranslationLoader.loadAllStrings(gameDir)
         val values: java.util.List = VoidrixTipsTranslationLoader.tipValues(translations)
         tipList = values
         titleCache = VoidrixTipsTranslationLoader.titleOrDefault(translations)
         return values
      }
   }
}
