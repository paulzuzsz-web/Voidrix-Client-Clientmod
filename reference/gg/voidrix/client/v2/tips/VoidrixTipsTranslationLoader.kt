...
@SourceDebugExtension(["SMAP\nVoidrixTipsTranslationLoader.kt\nKotlin\n*S Kotlin\n*F\n+ 1 VoidrixTipsTranslationLoader.kt\ngg/voidrix/client/v2/tips/VoidrixTipsTranslationLoader\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,101:1\n774#2:102\n865#2,2:103\n*S KotlinDebug\n*F\n+ 1 VoidrixTipsTranslationLoader.kt\ngg/voidrix/client/v2/tips/VoidrixTipsTranslationLoader\n*L\n66#1:102\n66#1:103,2\n*E\n"])
public object VoidrixTipsTranslationLoader {
   public const val TITLE_KEY: String = "voidrix.ui.tips.title"
   public const val TIP_KEY_PREFIX: String = "voidrix.ui.tips.value."
   private const val NAMESPACE: String = "noriskclient-cosmetics"
   private const val LANG_PREFIX: String = "lang/"
   private const val MODULE_FQN: String = "gg.voidrix.client.v2.modules.loadingtips.LoadingScreenTipsModule"

   @JvmStatic
   public fun isJvmTipsOverrideEnabled(): Boolean {
      return java.lang.Boolean.parseBoolean(System.getProperty("voidrix.tips.enabled", "true"))
   }
   ...
   public fun isTipsFeatureActive(): Boolean {
      ...
      if (!isJvmTipsOverrideEnabled()) {
         ...
         val var10000: Module = VoidrixReflectionUtil.tryLoadObject("gg.voidrix.client.v2.modules.loadingtips.LoadingScreenTipsModule") as Module
   ...
   public fun loadAllStrings(gameDir: File): Map<String, String> {
      if (!isTipsFeatureActive()) {
         ...
         val rel: java.lang.Iterable = VoidrixAssetReader.listKnownInCache$default(VoidrixAssetReader.INSTANCE, "noriskclient-cosmetics/lang/", null, 2, null)
         ...
         for (var15 in bytes as java.util.List) {
            val var10000: ByteArray = VoidrixAssetReader.tryReadBytesFromCache$default(
               VoidrixAssetReader.INSTANCE, "noriskclient-cosmetics", StringsKt.removePrefix(var15, "noriskclient-cosmetics/"), null, null, 12, null
            )
            if (var10000 != null) {
   ...
   public fun tipValues(translations: Map<String, String>): List<String> {
      ...
      for (var3 in translations.entrySet()) {
         ...
         if (StringsKt.startsWith$default(k, "voidrix.ui.tips.value.", false, 2, null) && !StringsKt.isBlank(v)) {
            values.add(v)
         }
      }
   ...
   public fun titleOrDefault(translations: Map<String, String>): String {
      val var10000: java.lang.String = translations.get("voidrix.ui.tips.title") as java.lang.String
