...
import gg.voidrix.client.v2.waypoints.xaero.XaeroReflect
...
public object DeathWaypointHandler {
         ...
         if (deathRecorded) {
            if (WaypointModule.INSTANCE.deathpoints) {
               ...
               if (XaeroReflect.INSTANCE.isXaeroAutoDeathpointsEnabled() == true) {
                  MCLoggerKt.voidrixDebugLog(logger, "waypoints", "Skipping Voidrix deathpoint — xaero handles it (AUTO_WAYPOINTS_ON_DEATH=true)")
               } else {
   ...
   private fun onPlayerDeath() {
      ...
      if (var10000.player != null) {
         ...
         deathRecorded = true
         MCLoggerKt.voidrixDebugLog(logger, "waypoints", "Death recorded at ${deathX}, ${deathY}, ${deathZ} in ${deathDimensionKey}")
      }
   }
      ...
      for (dimKey in PersistentWaypointStore.INSTANCE.getLoadedDimensionKeys()) {
         ...
         if (var10000 != null) {
            ...
            if (changed) {
               ...
               MCLoggerKt.voidrixDebugLog(logger, "waypoints", "Cleaned up death waypoints in $dimKey (oldDeathpoints=${WaypointModule.INSTANCE.oldDeathpoints})")
            }
         }
      }
   }
   ...
   private fun createDeathWaypoint() {
      if (deathDimensionKey != null) {
         ...
         PersistentWaypointStore.INSTANCE
            ...
            MCLoggerKt.voidrixDebugLog(logger, "waypoints", "Death waypoint created at ${deathX}, ${deathY}, ${deathZ} in $dimKey")
      }
   }
}
