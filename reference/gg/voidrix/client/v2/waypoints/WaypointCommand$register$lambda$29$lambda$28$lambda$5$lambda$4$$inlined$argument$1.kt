...
internal class `WaypointCommand$register$lambda$29$lambda$28$lambda$5$lambda$4$$inlined$argument$1` : Function0<Integer> {
   fun `WaypointCommand$register$lambda$29$lambda$28$lambda$5$lambda$4$$inlined$argument$1`(`$builder`: ArgumentCommandBuilder, `$name`: java.lang.String) {
