...
internal class `WaypointCommand$register$lambda$29$lambda$28$lambda$7$$inlined$argument$1` : Function0<java.lang.String> {
   fun `WaypointCommand$register$lambda$29$lambda$28$lambda$7$$inlined$argument$1`(`$builder`: ArgumentCommandBuilder, `$name`: java.lang.String) {
