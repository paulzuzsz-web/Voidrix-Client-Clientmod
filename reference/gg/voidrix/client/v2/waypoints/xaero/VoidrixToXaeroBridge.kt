...
import gg.voidrix.client.v2.waypoints.WaypointEditScreen
import gg.voidrix.client.v2.waypoints.WaypointModule
...
@SourceDebugExtension(["SMAP\nVoidrixToXaeroBridge.kt\nKotlin\n*S Kotlin\n*F\n+ 1 VoidrixToXaeroBridge.kt\ngg/voidrix/client/v2/waypoints/xaero/VoidrixToXaeroBridge\n+ 2 MCClient.kt\ngg/voidrix/compat/client/MCClient\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n+ 4 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,243:1\n328#2:244\n40#2:245\n355#2:246\n40#2:247\n356#2:248\n295#3,2:249\n1#4:251\n*S KotlinDebug\n*F\n+ 1 VoidrixToXaeroBridge.kt\ngg/voidrix/client/v2/waypoints/xaero/VoidrixToXaeroBridge\n*L\n62#1:244\n62#1:245\n63#1:246\n63#1:247\n63#1:248\n112#1:249,2\n*E\n"])
public object VoidrixToXaeroBridge {
   private const val LOG_TAG: String = "voidrix2xaero"
   private final val logger: Logger = MCLogger.getLogger("Voidrix-VoidrixToXaeroBridge")
   ...
   public fun handleOpenWaypoint(wmWaypoint: Any): Boolean {
      val var10000: SourceWaypoint = INSTANCE.resolveVoidrixFromWm(wmWaypoint)
      if (var10000 == null) {
         return false
      } else {
         ...
         if (var10 == null) {
            ...
            MCLoggerKt.voidrixDebugLog(logger, "voidrix2xaero", "handleOpenWaypoint: routing xaero edit to Voidrix for '${var10000.getName()}'")
            val var11: Minecraft = Minecraft.getInstance()
            var `screen$iv`: Screen = var11.gui.screen()
            `screen$iv` = WaypointEditScreen(var10000, var10, VoidrixWaypointSource.INSTANCE, if (`screen$iv` is Screen) `screen$iv` else null) as Screen
   ...
   public fun handleDeleteWaypoint(wmWaypoint: Any): Boolean {
      ...
      if (var10000 == null) {
         ...
         if (var3 == null) {
            ...
            MCLoggerKt.voidrixDebugLog(logger, "voidrix2xaero", "handleDeleteWaypoint: deleting Voidrix waypoint '${var10000.getName()}'")
            VoidrixWaypointSource.INSTANCE.delete(var3, var10000.getId())
            return true
         }
      }
   }
   ...
   public fun handleDisableWaypoint(wmWaypoint: Any): Boolean {
      ...
      if (var10000 == null) {
         ...
         if (var4 == null) {
            ...
            MCLoggerKt.voidrixDebugLog(logger, "voidrix2xaero", "handleDisableWaypoint: toggle disabled -> ${toggled.getDisabled()} for '${var10000.getName()}'")
            VoidrixWaypointSource.INSTANCE.update(var4, toggled)
            return true
         }
      }
   }

   private fun resolveVoidrixFromWm(wmWaypoint: Any): SourceWaypoint? {
      ...
      if (var10000 == null) {
         ...
         if (var10000 == null) {
            ...
            if (var10000 == null) {
               ...
               val var10: java.util.Iterator = VoidrixWaypointSource.INSTANCE.list(var10000).iterator()
            ...
            if (XaeroReflect.INSTANCE.isAvailable) {
               if (!INSTANCE.isInWorldRenderPath()) {
                  ...
                  try {
                     ...
                     val voidrixWaypoints: java.util.List = VoidrixWaypointSource.INSTANCE.list(var18)
                     if (!voidrixWaypoints.isEmpty()) {
                        var added: Int = 0

                        for (wp in voidrixWaypoints) {
                           if (!wp.getDisabled()) {
                              ...
                              val var22: Any = var19.newWaypoint$voidrix_client(
                                 var10001,
                                 var10002,
                                 var10003,
                                 var10004,
                                 ...
                                 wp.getColor(),
                                 XaeroReflect.INSTANCE.purposeFromName$voidrix_client(wp.getPurpose().name()),
                                 wp.getYIncluded()
                              )
                              if (var22 != null) {
                                 list.add(var22)
                        ...
                        if (added != lastMinimapCount) {
                           ...
                           MCLoggerKt.voidrixDebugLog(logger, "voidrix2xaero", "appendMinimap: now injecting $added Voidrix waypoint(s) for dim=$var18")
                        }
         ...
         if (WaypointModule.INSTANCE.isEnabled()) {
            if (XaeroReflect.INSTANCE.isAvailable) {
               ...
               try {
                  ...
                  val voidrixWaypoints: java.util.List = VoidrixWaypointSource.INSTANCE.list(var31)
                  if (!voidrixWaypoints.isEmpty()) {
                     var added: Int = 0
                     ...
                     for (wp in voidrixWaypoints) {
                        if (!wp.getDisabled()) {
                           ...
                           val minimapWp: Any = var32.newWaypoint$voidrix_client(
                              var10001,
                              var10002,
                              var10003,
                              var10004,
                     ...
                     if (added != lastWorldmapCount) {
                        ...
                        MCLoggerKt.voidrixDebugLog(logger, "voidrix2xaero", "appendWorldmap: now injecting $added Voidrix waypoint(s) for dim=$var31 (dimDiv=$dimDiv)")
                     }
