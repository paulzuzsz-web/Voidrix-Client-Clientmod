...
import gg.voidrix.compat.waypoint.persistent.WaypointVisibility
...
public object XaeroWaypointSource : WaypointSource {
   ...
   public open val isAvailable: Boolean
      public open get() {
         ...
         if (!XaeroReflect.INSTANCE.isAvailable) {
            MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "isAvailable=false (XaeroReflect not ready)")
            return false
         } else {
   ...
   public open fun listDimensions(): List<String> {
      MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "listDimensions() called")
      ...
      if (worlds.isEmpty()) {
         ...
         MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "listDimensions: no root worlds, falling back to currentWorld.dimKey=$dims")
         ...
         MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "listDimensions: ${worlds.size()} worlds, ${var19.size()} distinct dims: $var19")
         var20 = var19
      }
   ...
   public open fun list(dimensionKey: String): List<SourceWaypoint> {
      MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "list(dim='$dimensionKey') called")
      val var10000: XaeroWorld = this.worldForDim(dimensionKey)
      if (var10000 == null) {
         val var25: XaeroWaypointSource = this
         MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "list: no xaero world for dim '$dimensionKey'")
         ...
         for (`element$iv$iv` in `$this$flatMapTo$iv$iv`) {
            ...
            MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "list: set '${(`element$iv$iv` as XaeroWaypointSet).name}' has ${wps.size()} waypoint(s)")
   ...
   public open fun add(dimensionKey: String, waypoint: SourceWaypoint): Boolean {
      MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "add(dim='$dimensionKey', name='${waypoint.getName()}') called")
      val var10000: XaeroWorld = this.worldForDim(dimensionKey)
      if (var10000 == null) {
         val var17: XaeroWaypointSource = this
         MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "add: no xaero world for dim '$dimensionKey'")
         return false
      } else {
         ...
         if (var27 == null) {
            ...
            if (var27 == null) {
               ...
               MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "add: could not resolve a waypoint set")
               return false
            }
         }

         MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "add: using set '${var27.name}'")
         ...
         if (var31 == null) {
            ...
            MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "add: Waypoint ctor failed")
            return false
         } else {
            ...
            MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "add: set.add returned $var16")
            if (var16) {
               MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "add: persisted=${var10000.persist()}")
            }
   ...
   public open fun update(dimensionKey: String, waypoint: SourceWaypoint): Boolean {
      MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "update(dim='$dimensionKey', id='${waypoint.getId()}', name='${waypoint.getName()}') called")
      val var10000: XaeroWorld = this.worldForDim(dimensionKey)
      if (var10000 == null) {
         val var13: XaeroWaypointSource = this
         MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "update: no xaero world for dim '$dimensionKey'")
         return false
      } else {
         ...
         if (var15 == null) {
            ...
            MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "update: waypoint not found for id=${waypoint.getId()}")
            return false
         } else {
            MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "update: found in set '${var15.set.name}', applying change")
            ...
            MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "update: persisted=${var10000.persist()}")
            return true
         }
      }
   }
   ...
   public open fun delete(dimensionKey: String, id: String): Boolean {
      MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "delete(dim='$dimensionKey', id='$id') called")
      val var10000: XaeroWorld = this.worldForDim(dimensionKey)
      if (var10000 == null) {
         val var9: XaeroWaypointSource = this
         MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "delete: no xaero world for dim '$dimensionKey'")
         return false
      } else {
         ...
         if (var11 == null) {
            ...
            MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "delete: waypoint not found for id=$id")
            return false
         } else {
            val ok: Boolean = var11.set.remove(var11.waypoint)
            MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "delete: set.remove returned $ok")
            if (ok) {
               MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "delete: persisted=${var10000.persist()}")
            }
   ...
   private fun worldForDim(dimensionKey: String): XaeroWorld? {
      ...
      if ((if (current != null) current.dimKey else null) == dimensionKey) {
         MCLoggerKt.voidrixDebugLog(logger, "xaero-source", "worldForDim('$dimensionKey'): using currentWorld")
         return current
      } else {
   ...
   private fun findWaypoint(world: XaeroWorld, id: String): gg.voidrix.client.v2.waypoints.xaero.XaeroWaypointSource.FoundWaypoint? {
   ...
   private data class FoundWaypoint(set: XaeroWaypointSet, waypoint: XaeroWaypoint) {
      ...
      public fun copy(set: XaeroWaypointSet = this.set, waypoint: XaeroWaypoint = this.waypoint): gg.voidrix.client.v2.waypoints.xaero.XaeroWaypointSource.FoundWaypoint {
