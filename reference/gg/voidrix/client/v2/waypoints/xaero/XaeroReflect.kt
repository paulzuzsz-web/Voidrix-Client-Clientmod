...
public object XaeroReflect {
   ...
   private final val ctor_waypoint: Constructor<*>? by LazyKt.lazy(
      { 
         ...
         if (var10 == null) {
            ...
            MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Waypoint ctors available:\n    $var13")
         }
   ...
   private fun tryClass(name: String): Class<*>? {
      ...
      MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Class.forName('$name') -> ${if (found != null) "OK" else "MISSING"}")
      return found
   }

   private fun tryMethod0(clazz: Class<*>?, name: String): Method? {
      if (clazz == null) {
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method lookup '$name' skipped — owning class not resolved")
         return null
      } else {
   ...
   private fun trySetter(clazz: Class<*>?, name: String, paramType: Class<*>?): Method? {
      if (clazz != null && paramType != null) {
         ...
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Setter lookup '$name' skipped — owning class or param type not resolved")
         return null
      }
   }

   private fun logLookup(label: String, ok: Boolean, detail: String = "") {
      MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Lookup $label -> ${if (ok) "OK" else "MISSING"}${if (detail.length() > 0) " ($detail)" else ""}")
   }
   ...
   public fun dumpResolution() {
      ...
      var var10000: Logger
      run label244@{
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "=== XaeroReflect resolution dump ===")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "xaerominimap loaded: ${ModLoadingHelper.INSTANCE.isModLoaded("xaerominimap")}")
         var10000 = logger
      ...
      run label247@{
         MCLoggerKt.voidrixDebugLog(var10000, "xaero-reflect", "Class HudMod: $var13")
         var10000 = logger
      ...
      run label250@{
         MCLoggerKt.voidrixDebugLog(var10000, "xaero-reflect", "Class HudModule: $var13")
         var10000 = logger
      ...
      run label253@{
         MCLoggerKt.voidrixDebugLog(var10000, "xaero-reflect", "Class MinimapSession: $var13")
         var10000 = logger
      ...
      run label256@{
         MCLoggerKt.voidrixDebugLog(var10000, "xaero-reflect", "Class MinimapWorldManager: $var13")
         var10000 = logger
      ...
      run label259@{
         MCLoggerKt.voidrixDebugLog(var10000, "xaero-reflect", "Class MinimapWorld: $var13")
         var10000 = logger
      ...
      run label262@{
         MCLoggerKt.voidrixDebugLog(var10000, "xaero-reflect", "Class WaypointSet: $var13")
         var10000 = logger
      ...
      run label265@{
         MCLoggerKt.voidrixDebugLog(var10000, "xaero-reflect", "Class Waypoint: $var13")
         var10000 = logger
      ...
      run label268@{
         MCLoggerKt.voidrixDebugLog(var10000, "xaero-reflect", "Class WaypointColor: $var13")
         var10000 = logger
      ...
      run label271@{
         MCLoggerKt.voidrixDebugLog(var10000, "xaero-reflect", "Class WaypointPurpose: $var13")
         var10000 = logger
      ...
      run label274@{
         MCLoggerKt.voidrixDebugLog(var10000, "xaero-reflect", "Class WaypointVisibilityType: $var13")
         var10000 = logger
      ...
      run label277@{
         MCLoggerKt.voidrixDebugLog(var10000, "xaero-reflect", "Class ResourceKey: $var13")
         var10000 = logger
      ...
      run label280@{
         MCLoggerKt.voidrixDebugLog(var10000, "xaero-reflect", "Class ResourceLocation: $var13")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method HudMod.getHud: ${this.m_hudMod_getHud != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method Hud.getModuleManager: ${this.m_hud_getModuleManager != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method ModuleManager.getModules: ${this.m_moduleManager_getModules != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method HudModule.getId: ${this.m_hudModule_getId != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method HudModule.getCurrentSession: ${this.m_hudModule_getCurrentSession != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method MinimapSession.getWorldManager: ${this.m_minimapSession_getWorldManager != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method MinimapSession.getWorldManagerIO: ${this.m_minimapSession_getWorldManagerIO != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method MinimapWorldManagerIO.saveWorld(MinimapWorld): ${this.m_worldManagerIO_saveWorld != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method MinimapWorldManager.getCurrentWorld: ${this.m_worldManager_getCurrentWorld != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method MinimapWorldManager.getAutoRootContainer: ${this.m_worldManager_getAutoRootContainer != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method MinimapWorldContainer.getAllWorldsIterable: ${this.m_container_getAllWorldsIterable != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method MinimapWorld.getDimId: ${this.m_minimapWorld_getDimId != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method MinimapWorld.getIterableWaypointSets: ${this.m_minimapWorld_getIterableWaypointSets != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method MinimapWorld.getCurrentWaypointSet: ${this.m_minimapWorld_getCurrentWaypointSet != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method MinimapWorld.addWaypointSet(String): ${this.m_minimapWorld_addWaypointSet_String != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method WaypointSet.getName: ${this.m_waypointSet_getName != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method WaypointSet.getWaypoints: ${this.m_waypointSet_getWaypoints != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method WaypointSet.add(Waypoint): ${this.m_waypointSet_add != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method WaypointSet.remove(Waypoint): ${this.m_waypointSet_remove != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Ctor Waypoint(9-arg): ${this.ctor_waypoint != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method WaypointColor.getHex: ${this.m_color_getHex != null}")
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "Method WaypointColor.values(): ${this.m_color_values != null}")
         var10000 = logger
      ...
      MCLoggerKt.voidrixDebugLog(var10000, "xaero-reflect", "Method ResourceKey.<location-like>: $var13")
      MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "=== end dump ===")
   }
   ...
   public fun worldsInCurrentRoot(): List<XaeroWorld> {
      MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "worldsInCurrentRoot() called")
      val var1: XaeroReflect = this
      ...
      try {
         ...
         if (var10000 == null) {
            MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "worldsInCurrentRoot() -> empty (manager was null)")
            ...
            run label77@{
               ...
               if (var10000 != null) {
                  ...
                  if (var10000 != null) {
                     ...
                     var `$this$voidrixError$iv`: java.lang.Iterable = (java.lang.Iterable)(if (var36 != null) var36.invoke(var10000) else null)
                     val var37: java.lang.Iterable = `$this$voidrixError$iv` as? java.lang.Iterable
                     if ((`$this$voidrixError$iv` as? java.lang.Iterable) == null) {
                        MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "worldsInCurrentRoot() -> empty (getAllWorldsIterable returned non-iterable or null)")
                        var10000 = CollectionsKt.emptyList()
                        return@label77
                     }

                     `$this$voidrixError$iv` = CollectionsKt.filterNotNull(var37)
                     val `destination$iv$iv`: java.util.Collection = ArrayList(CollectionsKt.collectionSizeOrDefault(`$this$voidrixError$iv`, 10))

                     for (`item$iv$iv` in `$this$voidrixError$iv`) {
                        `destination$iv$iv`.add(XaeroWorld(`item$iv$iv`))
                     }

                     val var4: java.util.List = `destination$iv$iv` as java.util.List
                     MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "worldsInCurrentRoot() -> ${(`destination$iv$iv` as java.util.List).size()} worlds")
                     var10000 = var4
                     return@label77
                  }
               }

               MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "worldsInCurrentRoot() -> empty (autoRootContainer was null)")
               var10000 = CollectionsKt.emptyList()
            }
         }
   ...
   internal fun persistWorld(worldRaw: Any): Boolean {
      ...
      if (var10000 == null) {
         ...
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "persistWorld: no session")
         return false
      } else {
         ...
         if (var10000 != null) {
            ...
            if (var10000 != null) {
               ...
               if (var10000 == null) {
                  ...
                  MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "persistWorld: saveWorld method not resolved")
                  return false
               }
               ...
               try {
                  ...
                  MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "persistWorld: saved ${worldRaw.getClass().getSimpleName()}")
         ...
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "persistWorld: getWorldManagerIO returned null")
         return false
      }
   }
   ...
   internal fun newWaypoint(x: Int, y: Int, z: Int, name: String, initials: String, color: Int, purpose: Any?, yIncluded: Boolean): Any? {
      ...
      if (var10000 == null) {
         val var22: XaeroReflect = this
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "newWaypoint: ctor not resolved")
         return null
      } else {
         val ctor: Constructor = var10000
         var10000 = (Constructor)this.nearestColorEnum$voidrix_client(color)
         if (var10000 == null) {
            ...
            MCLoggerKt.voidrixDebugLog(var36, "xaero-reflect", "newWaypoint: could not derive WaypointColor for rgb=#$var10002")
            return null
         } else {
            val colorEnum: Any = var10000
            var10000 = (Constructor)purpose
            if (purpose == null) {
               var10000 = (Constructor)this.enumValue$voidrix_client(this.c_waypointPurpose, "NORMAL")
               if (var10000 == null) {
                  val var28: XaeroReflect = this
                  MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "newWaypoint: could not resolve WaypointPurpose")
                  return null
               }
            }
            ...
            try {
               ...
               val `$this$voidrixError$iv`: Any = ctor.newInstance(x, y, z, name, initials, colorEnum, purposeEnum, false, yIncluded)
               MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "newWaypoint: constructed Waypoint name='$name' at ($x,$y,$z)")
               `$this$newWaypoint_u24lambda_u24113` = (XaeroReflect)Result.constructor_impl/* $VF was: constructor-impl */(`$this$voidrixError$iv`)
   ...
   internal fun enumValue(clazz: Class<*>?, name: String): Any? {
      if (clazz == null) {
         ...
         if (var10000 != null) {
            MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "enumValue(${clazz.getSimpleName()}, '$name') threw: ${var10000.getMessage()}")
         }
   ...
   internal fun currentWaypointSetOf(worldRaw: Any): XaeroWaypointSet? {
      ...
      MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "currentWaypointSetOf: getCurrentWaypointSet returned null")
      return null
   }

   internal fun ensureWaypointSet(worldRaw: Any, setName: String): XaeroWaypointSet? {
      val var6: java.util.Iterator = this.waypointSetsOf$voidrix_client(worldRaw).iterator()
      ...
      if (var10000 as XaeroWaypointSet != null) {
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "ensureWaypointSet: '$setName' already exists")
         return existing
      } else {
         ...
         if (var14 != null) {
            ...
            if (var15 != null) {
               MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "ensureWaypointSet: created '$setName'")
               return XaeroWaypointSet(var15)
            }
         }

         val var12: XaeroReflect = this
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "ensureWaypointSet: addWaypointSet('$setName') returned null")
         return null
      }
   }
   ...
   internal fun addToSet(setRaw: Any, waypointRaw: Any): Boolean {
      ...
      if (var10000 == null) {
         ...
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "addToSet: add method handle null")
         return false
      } else {
         val m: Method = var10000
         ...
         try {
            ...
            MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "addToSet: succeeded")
            it = (XaeroReflect)Result.constructor_impl/* $VF was: constructor-impl */(true)
   ...
   internal fun removeFromSet(setRaw: Any, waypointRaw: Any): Boolean {
      ...
      if (var10000 == null) {
         val var18: XaeroReflect = this
         MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "removeFromSet: remove method handle null")
         return false
      } else {
         val m: Method = var10000
         val var4: XaeroReflect = this
         ...
         try {
            it = var4
            m.invoke(setRaw, waypointRaw)
            MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "removeFromSet: succeeded")
            it = (XaeroReflect)Result.constructor_impl/* $VF was: constructor-impl */(true)
         } catch (var11: java.lang.Throwable) {
            it = (XaeroReflect)Result.constructor_impl/* $VF was: constructor-impl */(ResultKt.createFailure(var11))
         }
   ...
   internal fun applyUpdate(
      ...
      MCLoggerKt.voidrixDebugLog(var10000, "xaero-reflect", "applyUpdate: name='$name' pos=($x,$y,$z) color=#$var10006 disabled=$disabled yIncluded=$yIncluded")
      ...
      val colorEnum: Any = this.nearestColorEnum$voidrix_client(color)
      if (colorEnum != null) {
   ...
   internal fun purposeFromName(name: String): Any? {
      return this.enumValue$voidrix_client(this.c_waypointPurpose, name)
   }

   internal fun visibilityFromName(name: String): Any? {
      return this.enumValue$voidrix_client(this.c_waypointVisibilityType, name)
   }
   ...
   public fun isXaeroAutoDeathpointsEnabled(): Boolean? {
      if (!this.isAvailable) {
         ...
         if (var28 != null) {
            MCLoggerKt.voidrixDebugLog(logger, "xaero-reflect", "isXaeroAutoDeathpointsEnabled threw: ${var28.getMessage()}")
         }
