...
import gg.voidrix.client.v2.waypoints.xaero.XaeroWaypointSource
...
public object WaypointModule : Module("Waypoints", ModuleCategory.QUALITY_OF_LIFE, false, true, false, 20) {
   ...
   public fun openEditScreen(waypoint: SourceWaypoint?, dimensionKey: String?, targetSource: WaypointSource = VoidrixWaypointSource.INSTANCE as WaypointSource) {
   ...
   fun {
      ...
      WaypointSourceRegistry.INSTANCE.register(VoidrixWaypointSource.INSTANCE)
