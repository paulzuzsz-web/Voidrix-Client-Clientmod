...
import gg.norisk.compat.testingloop.SyncTestRegistry
import gg.norisk.compat.testingloop.TestingLoopController
import gg.norisk.compat.text.LiteralTextBuilder
import gg.norisk.compat.text.NrcBranding
import gg.norisk.compat.text.NrcBranding.StatusRow
import kotlin.jvm.functions.Function0
import kotlin.jvm.internal.SourceDebugExtension
import kotlin.time.Duration
import net.minecraft.network.chat.Component

@SourceDebugExtension(["SMAP\nTestingLoopCommand.kt\nKotlin\n*S Kotlin\n*F\n+ 1 TestingLoopCommand.kt\ngg/norisk/client/v2/testingloop/TestingLoopCommand\n+ 2 NrcBranding.kt\ngg/norisk/compat/text/NrcBranding\n+ 3 TextBuilder.kt\ngg/norisk/compat/text/TextBuilderKt\n+ 4 TextBuilder.kt\ngg/norisk/compat/text/LiteralTextBuilder\n+ 5 CommandBuilder.kt\ngg/norisk/compat/command/CommandBuilder\n*L\n1#1,169:1\n83#2,2:170\n75#2:172\n76#2:177\n77#2:189\n78#2,8:201\n83#2,2:235\n75#2:237\n76#2:242\n77#2:254\n78#2,8:266\n83#2,2:322\n75#2:324\n76#2:329\n77#2:341\n78#2,8:364\n83#2,2:372\n75#2:374\n76#2:379\n77#2:391\n78#2,8:403\n83#2,2:411\n75#2:413\n76#2:418\n77#2:430\n78#2,8:442\n83#2,2:450\n75#2:452\n76#2:457\n77#2:469\n78#2,8:481\n8#3,4:173\n8#3,4:209\n8#3,4:238\n8#3,4:274\n8#3,4:325\n8#3,4:375\n8#3,4:414\n8#3,4:453\n78#4,6:178\n72#4,4:184\n87#4:188\n78#4,6:190\n72#4,4:196\n87#4:200\n78#4,6:213\n72#4,4:219\n87#4:223\n78#4,6:224\n72#4,4:230\n87#4:234\n78#4,6:243\n72#4,4:249\n87#4:253\n78#4,6:255\n72#4,4:261\n87#4:265\n78#4,6:278\n72#4,4:284\n87#4:288\n78#4,6:289\n72#4,4:295\n87#4:299\n78#4,6:300\n72#4,4:306\n87#4:310\n78#4,6:311\n72#4,4:317\n87#4:321\n78#4,6:330\n72#4,4:336\n87#4:340\n78#4,6:342\n72#4,4:348\n87#4:352\n78#4,6:353\n72#4,4:359\n87#4:363\n78#4,6:380\n72#4,4:386\n87#4:390\n78#4,6:392\n72#4,4:398\n87#4:402\n78#4,6:419\n72#4,4:425\n87#4:429\n78#4,6:431\n72#4,4:437\n87#4:441\n78#4,6:458\n72#4,4:464\n87#4:468\n78#4,6:470\n72#4,4:476\n87#4:480\n147#5,7:489\n147#5,7:496\n*S KotlinDebug\n*F\n+ 1 TestingLoopCommand.kt\ngg/norisk/client/v2/testingloop/TestingLoopCommand\n*L\n108#1:170,2\n108#1:172\n108#1:177\n108#1:189\n108#1:201,8\n152#1:235,2\n152#1:237\n152#1:242\n152#1:254\n152#1:266,8\n26#1:322,2\n26#1:324\n26#1:329\n26#1:341\n26#1:364,8\n33#1:372,2\n33#1:374\n33#1:379\n33#1:391\n33#1:403,8\n43#1:411,2\n43#1:413\n43#1:418\n43#1:430\n43#1:442,8\n47#1:450,2\n47#1:452\n47#1:457\n47#1:469\n47#1:481,8\n108#1:173,4\n121#1:209,4\n152#1:238,4\n159#1:274,4\n26#1:325,4\n33#1:375,4\n43#1:414,4\n47#1:453,4\n108#1:178,6\n108#1:184,4\n108#1:188\n109#1:190,6\n109#1:196,4\n109#1:200\n122#1:213,6\n122#1:219,4\n122#1:223\n123#1:224,6\n123#1:230,4\n123#1:234\n152#1:243,6\n152#1:249,4\n152#1:253\n153#1:255,6\n153#1:261,4\n153#1:265\n160#1:278,6\n160#1:284,4\n160#1:288\n161#1:289,6\n161#1:295,4\n161#1:299\n162#1:300,6\n162#1:306,4\n162#1:310\n163#1:311,6\n163#1:317,4\n163#1:321\n26#1:330,6\n26#1:336,4\n26#1:340\n27#1:342,6\n27#1:348,4\n27#1:352\n28#1:353,6\n28#1:359,4\n28#1:363\n33#1:380,6\n33#1:386,4\n33#1:390\n34#1:392,6\n34#1:398,4\n34#1:402\n43#1:419,6\n43#1:425,4\n43#1:429\n44#1:431,6\n44#1:437,4\n44#1:441\n47#1:458,6\n47#1:464,4\n47#1:468\n48#1:470,6\n48#1:476,4\n48#1:480\n70#1:489,7\n86#1:496,7\n*E\n"])
public object TestingLoopCommand {
                              ...
                              `$this$literal`.runsSuccess(
                                 { $this$runsSuccess: CommandExecutionContext ->
                                    if (TestingLoopController.INSTANCE.start()) {
                                       val `$this$iv`: NrcBranding = NrcBranding.INSTANCE
                                       ...
                                       val var24: NrcBranding = NrcBranding.INSTANCE
                                       val `this_$iv$ivx`: LiteralTextBuilder = LiteralTextBuilder(null, true)
                                       `this_$iv$ivx`.getAppendTasks()
                                          .add(
                           ...
                           { $this$literal: LiteralCommandBuilder ->
                              `$this$literal`.runsSuccess(
                                 { $this$runsSuccess: CommandExecutionContext ->
                                    ...
                                    NrcBranding.sendToggle$default(
                                       NrcBranding.INSTANCE, "TestingLoop", "announce", TestingLoopController.INSTANCE.getAnnounceInChat(), 0, null, 24, null
                                    )
                                    Unit.INSTANCE
                                 }
                              )
   ...
   private fun showHelp() {
      val commands: NrcBranding = NrcBranding.INSTANCE
      val `this_$iv$ivx`: LiteralTextBuilder = LiteralTextBuilder(null, true)
      ...
      for (var27 in CollectionsKt.listOf(
         arrayOf(
            TuplesKt.to("/nrc debug testingloop start", "Start the loop"),
            TuplesKt.to("/nrc debug testingloop stop", "Stop the loop"),
            TuplesKt.to("/nrc debug testingloop status", "Show running state, period, announce flag"),
            TuplesKt.to("/nrc debug testingloop list", "List registered tests"),
            TuplesKt.to("/nrc debug testingloop announce", "Toggle chat announce (other accounts can see)"),
            TuplesKt.to("/nrc debug testingloop period <seconds>", "Set delay between tests"),
            TuplesKt.to("/nrc debug testingloop single <id>", "Run one test once")
         )
      )) {
   ...
   private fun showStatus() {
      NrcBranding.sendStatus$default(
         NrcBranding.INSTANCE,
         "TestingLoop",
         0,
   ...
   private fun showList() {
      ...
      if (tests.isEmpty()) {
         val var25: NrcBranding = NrcBranding.INSTANCE
         val `this_$iv$ivx`: LiteralTextBuilder = LiteralTextBuilder(null, true)
         ...
         MCClient.sendMessage(NrcBranding.header$default(NrcBranding.INSTANCE, "TestingLoop (${tests.size()})", 0, 2, null) as Component)
         ...
         MCClient.sendMessage(NrcBranding.footer$default(NrcBranding.INSTANCE, 0, 1, null) as Component)
      }
   }
}
