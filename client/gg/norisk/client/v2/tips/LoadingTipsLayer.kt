...
public object LoadingTipsLayer {
   ...
   private fun tryApplyTipsToLabels(titleLabel: LabelComponent, tipLabel: LabelComponent): Boolean {
      if (!NrcTipsTranslationLoader.isTipsFeatureActive()) {
         ...
         val var11: LoadingTipRenderStrings = NrcLoadingTipsPresenter.updateAndGetStringsForRender(var10, System.currentTimeMillis())
         if (var11 == null) {
            return false
         } else {
