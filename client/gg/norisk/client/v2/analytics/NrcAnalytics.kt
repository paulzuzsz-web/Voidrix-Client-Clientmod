...
import gg.norisk.compat.event.LocalCosmeticEquippedEvent
import gg.norisk.compat.event.LocalEmoteSelectedEvent
import gg.norisk.compat.event.ThemeModeChangedEvent
...
import gg.norisk.ui.config.profile.ProfileManager
import gg.norisk.ui.events.ModuleEvents
import gg.norisk.ui.events.ModuleEvents.ModuleToggleEvent
...
@SourceDebugExtension(["SMAP\nNrcAnalytics.kt\nKotlin\n*S Kotlin\n*F\n+ 1 NrcAnalytics.kt\ngg/norisk/client/v2/analytics/NrcAnalytics\n+ 2 CoroutineTask.kt\ngg/norisk/compat/task/CoroutineTaskKt\n+ 3 MCServer.kt\ngg/norisk/compat/host/MCServer\n+ 4 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n+ 5 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 6 _Maps.kt\nkotlin/collections/MapsKt___MapsKt\n+ 7 MCLogger.kt\ngg/norisk/compat/client/MCLoggerKt\n*L\n1#1,269:1\n18#2,12:270\n18#2,12:283\n18#2,12:297\n18#2,12:309\n18#2,12:321\n95#3:282\n1869#4,2:295\n1869#4,2:336\n1869#4,2:338\n1869#4,2:340\n1#5:333\n216#6,2:334\n60#7:342\n*S KotlinDebug\n*F\n+ 1 NrcAnalytics.kt\ngg/norisk/client/v2/analytics/NrcAnalytics\n*L\n109#1:270,12\n143#1:283,12\n183#1:297,12\n202#1:309,12\n227#1:321,12\n133#1:282\n164#1:295,2\n87#1:336,2\n89#1:338,2\n91#1:340,2\n253#1:334,2\n24#1:342\n*E\n"])
public object NrcAnalytics {
   private final val logger: Logger by LazyKt.lazy(NrcAnalytics$special$$inlined$lazyLogger$1.INSTANCE)
      private final get() {
   ...
   public fun init() {
      if (initialized.compareAndSet(false, true)) {
         if (!NrcAnalyticsConfig.INSTANCE.isEnabled()) {
            INSTANCE.logger.info("[Analytics] Disabled (${NrcAnalyticsConfig.INSTANCE.serverModeLabel()}). Enable with -Dnorisk.analytics.enabled=true")
         } else {
            val var0: NrcAnalytics = INSTANCE

            var `$this$init_u24lambda_u240`: Any
            try {
               val var3: AnalyticsClient = AnalyticsClient(NrcAnalyticsConfig.INSTANCE.baseUrl())
               var3.setUserContext(AnalyticsUtils.generatePersistentUserId(), AnalyticsUtils.systemProperties())
               client = var3
               var0.logger.info("[Analytics] Ready (${NrcAnalyticsConfig.INSTANCE.serverModeLabel()}) → ${NrcAnalyticsConfig.INSTANCE.trackUrl()}")
            ...
            ClientEvents.INSTANCE.getClientStoppingEvent().listen({ it: Unit ->
               val var1: NrcAnalytics = INSTANCE
   ...
   public fun isReady(): Boolean {
      return client != null && NrcAnalyticsConfig.INSTANCE.isEnabled()
   }
      ...
      if (NrcAnalyticsConfig.INSTANCE.isEnabled()) {
         if (client != null) {
            ...
            BuildersKt.launch$default(
               ...
               null,
               null,
               NrcAnalytics$track$$inlined$mcCoroutineTask-ML416i8$default$1(
   ...
   private fun scheduleThemeChangedTrack() {
      ...
      themeChangeDebounceJob = BuildersKt.launch$default(
         ...
         null,
         null,
         NrcAnalytics$scheduleThemeChangedTrack$$inlined$mcCoroutineTask-ML416i8$default$1(
            ...
            if (event.getEnabled() && !wasEnabled) {
               moduleToggleDebounceJobs.put(
                  ...
                  BuildersKt.launch$default(
                     ...
                     null,
                     null,
                     NrcAnalytics$onModuleToggle$$inlined$mcCoroutineTask-ML416i8$default$1(
      ...
      if (usageTrackingEnabled.get()) {
         ...
         emotePlayDebounceJobs.put(
            ...
            BuildersKt.launch$default(
               ...
               null,
               null,
               NrcAnalytics$onLocalEmoteSelected$$inlined$mcCoroutineTask-ML416i8$default$1(
      ...
      if (usageTrackingEnabled.get()) {
         ...
         cosmeticEquipDebounceJobs.put(
            ...
            BuildersKt.launch$default(
               ...
               null,
               null,
               NrcAnalytics$onLocalCosmeticEquipped$$inlined$mcCoroutineTask-ML416i8$default$1(
