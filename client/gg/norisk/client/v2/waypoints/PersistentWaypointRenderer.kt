...
import gg.norisk.compat.render.RendererUtils
import gg.norisk.compat.ui.hud.BatchedHudManager
import gg.norisk.compat.ui.hud.IBatchedHudRenderer
import gg.norisk.compat.waypoint.persistent.PersistentWaypoint
import gg.norisk.ui.v2.hud.BatchedHudRendererProvider
...
public object PersistentWaypointRenderer {
   ...
   private final val renderCache: HashMap<UUID, gg.norisk.client.v2.waypoints.PersistentWaypointRenderer.WaypointRenderData> = HashMap()
   private final var visibleBuffer: ArrayList<gg.norisk.client.v2.waypoints.PersistentWaypointRenderer.VisibleEntry> = ArrayList(64)
   ...
   private class VisibleEntry(waypoint: PersistentWaypoint, cache: gg.norisk.client.v2.waypoints.PersistentWaypointRenderer.WaypointRenderData) {
      public final val waypoint: PersistentWaypoint
      public final val cache: gg.norisk.client.v2.waypoints.PersistentWaypointRenderer.WaypointRenderData
