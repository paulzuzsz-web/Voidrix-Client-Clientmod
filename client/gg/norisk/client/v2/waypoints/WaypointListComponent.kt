...
import gg.norisk.ui.components.nrc.NrcDropdownComponent
...
public class WaypointListComponent : FlowLayout(Sizing.Companion.fill(), Sizing.Companion.content(), Algorithm.VERTICAL) {
   ...
   private fun build() {
      ...
      if (sources.isEmpty()) {
         val var10001: gg.norisk.owolib.owo.ui.component.LabelComponent.Companion = LabelComponent.Companion
         val var9: Array<Any> = arrayOfNulls(0)
         val var10002: MutableComponent = Component.translatable("nrc.ui.label.no_waypoints", Arrays.copyOf(var9, var9.length))
   ...
   @SourceDebugExtension(["SMAP\nWaypointListComponent.kt\nKotlin\n*S Kotlin\n*F\n+ 1 WaypointListComponent.kt\ngg/norisk/client/v2/waypoints/WaypointListComponent$Companion\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,269:1\n1#2:270\n*E\n"])
   ...
   @SourceDebugExtension(["SMAP\nWaypointListComponent.kt\nKotlin\n*S Kotlin\n*F\n+ 1 WaypointListComponent.kt\ngg/norisk/client/v2/waypoints/WaypointListComponent$SourceSection\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 3 Text.kt\ngg/norisk/compat/text/TextKt\n*L\n1#1,269:1\n1#2:270\n67#3:271\n66#3:272\n*S KotlinDebug\n*F\n+ 1 WaypointListComponent.kt\ngg/norisk/client/v2/waypoints/WaypointListComponent$SourceSection\n*L\n142#1:271\n113#1:272\n*E\n"])
   private inner class SourceSection(source: WaypointSource) : FlowLayout(Sizing.Companion.fill(), Sizing.Companion.content(), Algorithm.VERTICAL) {
      ...
      public fun rebuild() {
         ...
         val var10: NrcDropdownComponent = NrcDropdownComponent(var8, this.selectedDimension, { it: java.lang.String ->
         ...
         if (this.source.isWritable()) {
            val var5: V3Button = V3Button(TextKt.toSmallCaps("+ New"), { button: NrcLabelButton, var2: Double, var4: Double, var6: Int ->
      ...
      private fun rebuildListOnly() {
         ...
         // Bytecode:
         // 000: aload 0
         // 001: getfield gg/norisk/client/v2/waypoints/WaypointListComponent$SourceSection.listContainer Lgg/norisk/owolib/owo/ui/container/FlowLayout;
         // 004: invokevirtual gg/norisk/owolib/owo/ui/container/FlowLayout.clearChildren ()Lgg/norisk/owolib/owo/ui/container/FlowLayout;
         // 007: pop
         // 008: aload 0
         // 009: getfield gg/norisk/client/v2/waypoints/WaypointListComponent$SourceSection.source Lgg/norisk/compat/waypoint/source/WaypointSource;
         // 00c: aload 0
         // 00d: getfield gg/norisk/client/v2/waypoints/WaypointListComponent$SourceSection.selectedDimension Ljava/lang/String;
         // 010: invokeinterface gg/norisk/compat/waypoint/source/WaypointSource.list (Ljava/lang/String;)Ljava/util/List; 2
         // 015: astore 1
         // 016: aload 1
         // 017: invokeinterface java/util/List.isEmpty ()Z 1
         // 01c: ifeq 07d
         // 01f: aload 0
         // 020: getfield gg/norisk/client/v2/waypoints/WaypointListComponent$SourceSection.listContainer Lgg/norisk/owolib/owo/ui/container/FlowLayout;
         // 023: getstatic gg/norisk/owolib/owo/ui/component/LabelComponent.Companion Lgg/norisk/owolib/owo/ui/component/LabelComponent$Companion;
         // 026: ldc_w "nrc.ui.label.no_waypoints"
         // 029: astore 2
         // 02a: bipush 0
         // 02b: anewarray 285
         // 02e: astore 3
         ...
         // 046: invokevirtual gg/norisk/owolib/owo/ui/component/LabelComponent$Companion.create (Lnet/minecraft/network/chat/Component;)Lgg/norisk/owolib/owo/ui/component/LabelComponent;
         // 049: astore 2
         // 04a: aload 2
         // 04b: astore 3
         // 04c: astore 8
         ...
         // 04f: istore 4
         // 051: aload 3
         // 052: getstatic gg/norisk/owolib/owo/ui/core/Sizing.Companion Lgg/norisk/owolib/owo/ui/core/Sizing$Companion;
         // 055: invokevirtual gg/norisk/owolib/owo/ui/core/Sizing$Companion.fill ()Lgg/norisk/owolib/owo/ui/core/Sizing;
         // 058: invokevirtual gg/norisk/owolib/owo/ui/component/LabelComponent.horizontalSizing (Lgg/norisk/owolib/owo/ui/core/Sizing;)Lgg/norisk/owolib/owo/ui/core/UIComponent;
         // 05b: pop
         // 05c: aload 3
         // 05d: getstatic gg/norisk/owolib/owo/ui/core/HorizontalAlignment.CENTER Lgg/norisk/owolib/owo/ui/core/HorizontalAlignment;
         // 060: invokevirtual gg/norisk/owolib/owo/ui/component/LabelComponent.horizontalTextAlignment (Lgg/norisk/owolib/owo/ui/core/HorizontalAlignment;)Lgg/norisk/owolib/owo/ui/component/LabelComponent;
         // 063: pop
         // 064: aload 3
         // 065: getstatic gg/norisk/owolib/owo/ui/core/Insets.Companion Lgg/norisk/owolib/owo/ui/core/Insets$Companion;
         // 068: bipush 10
         // 06a: invokevirtual gg/norisk/owolib/owo/ui/core/Insets$Companion.of (I)Lgg/norisk/owolib/owo/ui/core/Insets;
         // 06d: invokevirtual gg/norisk/owolib/owo/ui/component/LabelComponent.margins (Lgg/norisk/owolib/owo/ui/core/Insets;)Lgg/norisk/owolib/owo/ui/base/BaseUIComponent;
         // 070: pop
         // 071: nop
         // 072: aload 8
         // 074: aload 2
         // 075: checkcast gg/norisk/owolib/owo/ui/core/UIComponent
         // 078: invokevirtual gg/norisk/owolib/owo/ui/container/FlowLayout.child (Lgg/norisk/owolib/owo/ui/core/UIComponent;)Lgg/norisk/owolib/owo/ui/container/FlowLayout;
         // 07b: pop
         // 07c: return
         // 07d: aload 1
         ...
         // 09d: astore 3
         // 09e: getstatic gg/norisk/owolib/owo/ui/container/FlowLayout.Companion Lgg/norisk/owolib/owo/ui/container/FlowLayout$Companion;
         // 0a1: getstatic gg/norisk/owolib/owo/ui/core/Sizing.Companion Lgg/norisk/owolib/owo/ui/core/Sizing$Companion;
         // 0a4: invokevirtual gg/norisk/owolib/owo/ui/core/Sizing$Companion.fill ()Lgg/norisk/owolib/owo/ui/core/Sizing;
         // 0a7: getstatic gg/norisk/owolib/owo/ui/core/Sizing.Companion Lgg/norisk/owolib/owo/ui/core/Sizing$Companion;
         // 0aa: invokevirtual gg/norisk/owolib/owo/ui/core/Sizing$Companion.content ()Lgg/norisk/owolib/owo/ui/core/Sizing;
         // 0ad: invokevirtual gg/norisk/owolib/owo/ui/container/FlowLayout$Companion.horizontal (Lgg/norisk/owolib/owo/ui/core/Sizing;Lgg/norisk/owolib/owo/ui/core/Sizing;)Lgg/norisk/owolib/owo/ui/container/FlowLayout;
         // 0b0: astore 5
         // 0b2: aload 5
         // 0b4: astore 6
         // 0b6: bipush 0
         ...
         // 0b9: aload 6
         // 0bb: bipush 5
         // 0bc: invokevirtual gg/norisk/owolib/owo/ui/container/FlowLayout.gap (I)Lgg/norisk/owolib/owo/ui/container/FlowLayout;
         // 0bf: pop
         // 0c0: aload 6
         // 0c2: getstatic gg/norisk/owolib/owo/ui/core/Insets.Companion Lgg/norisk/owolib/owo/ui/core/Insets$Companion;
         // 0c5: bipush 1
         // 0c6: invokevirtual gg/norisk/owolib/owo/ui/core/Insets$Companion.of (I)Lgg/norisk/owolib/owo/ui/core/Insets;
         // 0c9: bipush 4
         // 0ca: invokevirtual gg/norisk/owolib/owo/ui/core/Insets.withLeft (I)Lgg/norisk/owolib/owo/ui/core/Insets;
         // 0cd: invokevirtual gg/norisk/owolib/owo/ui/container/FlowLayout.padding (Lgg/norisk/owolib/owo/ui/core/Insets;)Lgg/norisk/owolib/owo/ui/core/ParentUIComponent;
         // 0d0: pop
         // 0d1: aload 6
         // 0d3: bipush 1
         // 0d4: invokevirtual gg/norisk/owolib/owo/ui/container/FlowLayout.allowOverflow (Z)Lgg/norisk/owolib/owo/ui/core/ParentUIComponent;
         // 0d7: pop
         // 0d8: nop
         // 0d9: aload 5
         // 0db: astore 4
         ...
         // 0f6: checkcast gg/norisk/compat/waypoint/source/SourceWaypoint
         // 0f9: astore 6
         // 0fb: aload 4
         // 0fd: new gg/norisk/client/v2/waypoints/WaypointListComponent$WaypointEntry
         // 100: dup
         // 101: aload 6
         // 103: aload 0
         // 104: getfield gg/norisk/client/v2/waypoints/WaypointListComponent$SourceSection.source Lgg/norisk/compat/waypoint/source/WaypointSource;
         // 107: aload 0
         // 108: getfield gg/norisk/client/v2/waypoints/WaypointListComponent$SourceSection.selectedDimension Ljava/lang/String;
         // 10b: new gg/norisk/client/v2/waypoints/WaypointListComponent$SourceSection$rebuildListOnly$2
         // 10e: dup
         // 10f: aload 0
         // 110: invokespecial gg/norisk/client/v2/waypoints/WaypointListComponent$SourceSection$rebuildListOnly$2.<init> (Ljava/lang/Object;)V
         // 113: checkcast kotlin/jvm/functions/Function0
         // 116: invokespecial gg/norisk/client/v2/waypoints/WaypointListComponent$WaypointEntry.<init> (Lgg/norisk/compat/waypoint/source/SourceWaypoint;Lgg/norisk/compat/waypoint/source/WaypointSource;Ljava/lang/String;Lkotlin/jvm/functions/Function0;)V
         // 119: checkcast gg/norisk/owolib/owo/ui/core/UIComponent
         // 11c: invokevirtual gg/norisk/owolib/owo/ui/container/FlowLayout.child (Lgg/norisk/owolib/owo/ui/core/UIComponent;)Lgg/norisk/owolib/owo/ui/container/FlowLayout;
         // 11f: pop
         // 120: goto 0e5
         // 123: aload 0
         // 124: getfield gg/norisk/client/v2/waypoints/WaypointListComponent$SourceSection.listContainer Lgg/norisk/owolib/owo/ui/container/FlowLayout;
         // 127: aload 4
         // 129: checkcast gg/norisk/owolib/owo/ui/core/UIComponent
         // 12c: invokevirtual gg/norisk/owolib/owo/ui/container/FlowLayout.child (Lgg/norisk/owolib/owo/ui/core/UIComponent;)Lgg/norisk/owolib/owo/ui/container/FlowLayout;
         // 12f: pop
         // 130: goto 08b
         // 133: return
      }
   ...
   @SourceDebugExtension(["SMAP\nWaypointListComponent.kt\nKotlin\n*S Kotlin\n*F\n+ 1 WaypointListComponent.kt\ngg/norisk/client/v2/waypoints/WaypointListComponent$WaypointEntry\n+ 2 TextBuilder.kt\ngg/norisk/compat/text/TextBuilderKt\n*L\n1#1,269:1\n11#2:270\n*S KotlinDebug\n*F\n+ 1 WaypointListComponent.kt\ngg/norisk/client/v2/waypoints/WaypointListComponent$WaypointEntry\n*L\n238#1:270\n*E\n"])
