...
public object WaypointCommand {
                        ...
                        `$this$literal`.runsSuccess(
                           lambda_29_lambda_28_lambda_17_lambda_16@{ $this$runsSuccess: CommandExecutionContext ->
                              ...
                              if (waypoints.isEmpty()) {
                                 val var27: NrcBranding = NrcBranding.INSTANCE
                                 ...
                                 (`$this$runsSuccess`.getSource() as ClientCommandSource)
                                    .sendSuccess(NrcBranding.header$default(NrcBranding.INSTANCE, "Waypoints ($var10000)", 0, 2, null) as Component)
                                 ...
                                 (`$this$runsSuccess`.getSource() as ClientCommandSource)
                                    .sendSuccess(NrcBranding.footer$default(NrcBranding.INSTANCE, 0, 1, null) as Component)
                                    return@lambda_29_lambda_28_lambda_17_lambda_16 Unit.INSTANCE
                              }
                           }
                        )
   ...
   private fun showHelp() {
      ...
      for (var27 in CollectionsKt.listOf(
         arrayOf(
            TuplesKt.to("/nrc waypoint create <name>", "Create at your position"),
            TuplesKt.to("/nrc waypoint createcolor <name> <color>", "Create with specific color"),
            TuplesKt.to("/nrc waypoint delete <name>", "Delete a waypoint"),
            TuplesKt.to("/nrc waypoint list", "List all waypoints"),
            TuplesKt.to("/nrc waypoint navigate <name>", "Navigate to a waypoint"),
            TuplesKt.to("/nrc waypoint debug", "Stress-test commands (stress, stress-dense, clear)")
         )
      )) {
   ...
   private fun createAtPlayerPos(name: String, colorOverride: Int?) {
      ...
      if (var10000.player != null) {
         ...
         if (wp != null) {
            ...
            val var34: NrcBranding = NrcBranding.INSTANCE
            val `this_$iv$ivx`: LiteralTextBuilder = LiteralTextBuilder(null, true)
   ...
   private fun showDebugHelp() {
      ...
      for (var27 in CollectionsKt.listOf(
         arrayOf(
            TuplesKt.to("/nrc waypoint debug stress <count>", "Spawn N waypoints in 4-block grid"),
            TuplesKt.to("/nrc waypoint debug stress-dense <count>", "Spawn N waypoints in 2-block grid"),
            TuplesKt.to("/nrc waypoint debug clear", "Clear all transient debug waypoints")
         )
      )) {
         val var28: java.lang.String = var27.component1() as java.lang.String
         val desc: java.lang.String = var27.component2() as java.lang.String
   ...
   private fun stressGrid(count: Int, spacing: Int) {
      ...
      if (var10000.player == null) {
         ...
         val var40: NrcBranding = NrcBranding.INSTANCE
         val `this_$iv$ivx`: LiteralTextBuilder = LiteralTextBuilder(null, true)
         ...
         val var45: NrcBranding = NrcBranding.INSTANCE
         val `this_$iv$ivx`: LiteralTextBuilder = LiteralTextBuilder(null, true)
