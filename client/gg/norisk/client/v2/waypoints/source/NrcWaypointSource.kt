package gg.norisk.client.v2.waypoints.source
...
import gg.norisk.compat.waypoint.source.WaypointSourceKt
import java.util.ArrayList
import java.util.UUID
import kotlin.jvm.internal.SourceDebugExtension

@SourceDebugExtension(["SMAP\nNrcWaypointSource.kt\nKotlin\n*S Kotlin\n*F\n+ 1 NrcWaypointSource.kt\ngg/norisk/client/v2/waypoints/source/NrcWaypointSource\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n+ 3 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,85:1\n1563#2:86\n1634#2,3:87\n1761#2,3:91\n295#2,2:94\n1#3:90\n*S KotlinDebug\n*F\n+ 1 NrcWaypointSource.kt\ngg/norisk/client/v2/waypoints/source/NrcWaypointSource\n*L\n29#1:86\n29#1:87,3\n71#1:91,3\n78#1:94,2\n*E\n"])
public object NrcWaypointSource : WaypointSource {
   public open val id: String = "nrc"
   ...
   public open fun update(dimensionKey: String, waypoint: SourceWaypoint): Boolean {
      val modified: NrcWaypointSource = this

      var `$this$update_u24lambda_u241`: NrcWaypointSource
      try {
         `$this$update_u24lambda_u241` = modified
         `$this$update_u24lambda_u241` = (NrcWaypointSource)Result.constructor_impl/* $VF was: constructor-impl */(UUID.fromString(waypoint.getId()))
      } catch (var8: java.lang.Throwable) {
         `$this$update_u24lambda_u241` = (NrcWaypointSource)Result.constructor_impl/* $VF was: constructor-impl */(ResultKt.createFailure(var8))
      }
   ...
   public open fun delete(dimensionKey: String, id: String): Boolean {
      run label27@{
         val var4: NrcWaypointSource = this

         var `$this$delete_u24lambda_u244`: NrcWaypointSource
         try {
            `$this$delete_u24lambda_u244` = var4
            `$this$delete_u24lambda_u244` = (NrcWaypointSource)Result.constructor_impl/* $VF was: constructor-impl */(UUID.fromString(id))
         } catch (var7: java.lang.Throwable) {
            `$this$delete_u24lambda_u244` = (NrcWaypointSource)Result.constructor_impl/* $VF was: constructor-impl */(ResultKt.createFailure(var7))
         }
