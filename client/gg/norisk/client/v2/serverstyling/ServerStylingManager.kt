...
import gg.norisk.client.v2.serverstyling.data.Gamemode
import gg.norisk.client.v2.serverstyling.data.GamemodeDeserializer
import gg.norisk.client.v2.serverstyling.data.ServerStyleManifest
import gg.norisk.client.v2.serverstyling.data.StyledServer
...
@NrcMiniTag(tags = ["server-styling"])
@SourceDebugExtension(["SMAP\nServerStylingManager.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ServerStylingManager.kt\ngg/norisk/client/v2/serverstyling/ServerStylingManager\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,98:1\n1#2:99\n1761#3,3:100\n1761#3,3:103\n*S KotlinDebug\n*F\n+ 1 ServerStylingManager.kt\ngg/norisk/client/v2/serverstyling/ServerStylingManager\n*L\n88#1:100,3\n94#1:103,3\n*E\n"])
public object ServerStylingManager {
   ...
   private const val NAMESPACE: String = "noriskclient"
   ...
   private fun tryLoadInline(): Boolean {
      val var10000: ByteArray = NrcAssetReader.tryReadBytesFromCache$default(
         NrcAssetReader.INSTANCE, "noriskclient", "merged/merged-manifest.json", null, null, 12, null
      )
   ...
   private fun parseAndCommit(bytes: ByteArray): Boolean {
      ...
      try {
         ...
         loaded = true
         DevUtilsKt.nrcDebug(it, "Loaded server styling manifest (${styledServers.size()} servers)")
      ...
      if (var10000 == null) {
         ...
         DevUtilsKt.nrcError(INSTANCE, "Failed to parse noriskclient:merged/merged-manifest.json", var10000)
         var11 = false
      }
