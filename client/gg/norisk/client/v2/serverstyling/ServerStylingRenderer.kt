...
public object ServerStylingRenderer {
   ...
   private fun loadTexture(assetPath: String): Identifier? {
      val var10000: Identifier = Identifier.fromNamespaceAndPath("noriskclient", "merged/$assetPath")
   ...
   private fun loadDevTexture(assetPath: String, identifier: Identifier): Boolean {
      if (registeredDevTextures.contains(assetPath)) {
         ...
         val var10000: ByteArray = NrcAssetReader.tryReadBytes$default(NrcAssetReader.INSTANCE, "noriskclient", "merged/$assetPath", null, null, 12, null)
         if (var10000 == null) {
            return false
         } else {
            ...
            try {
               ...
               DevUtilsKt.nrcDebug(this, "Loaded dev texture: $assetPath")
               nativeImage = true
            } catch (var14: Exception) {
               DevUtilsKt.nrcError(this, "Failed to load dev texture noriskclient:merged/$assetPath: ${var14.getMessage()}", var14)
               nativeImage = false
            }
