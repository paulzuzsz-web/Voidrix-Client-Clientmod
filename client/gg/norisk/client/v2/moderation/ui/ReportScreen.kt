package gg.norisk.client.v2.moderation.ui
...
import gg.norisk.cosmetics.v2.ui.preview.CosmeticPlayerPreviewProvider
import gg.norisk.cosmetics.v2.ui.preview.CosmeticShowcasePlayer
import gg.norisk.owolib.owo.ui.base.BaseOwoScreen
import gg.norisk.owolib.owo.ui.component.LabelComponent
import gg.norisk.owolib.owo.ui.component.entity.EntityComponent
import gg.norisk.owolib.owo.ui.container.FlowLayout
import gg.norisk.owolib.owo.ui.container.OverlayContainer
...
import gg.norisk.ui.components.nrc.NrcInputField
...
public class ReportScreen(targetUuid: UUID) : BaseOwoScreen(null, 1), INRCScreen {
   ...
   protected open fun createAdapter(): OwoUIAdapter<FlowLayout> {
      return OwoUIAdapter.Companion.create(this as Screen, gg/norisk/client/v2/moderation/ui/ReportScreen##Lambda_0_95())
   }
   ...
   protected open fun build(rootComponent: FlowLayout) {
      ...
      NrcDialog.Companion
         .openConfirmDialogNoEscape(
            ...
            { dialog: NrcDialog, overlay: OverlayContainer ->
               ...
               var var10001: MutableComponent = Component.translatable("nrc.moderation.report.title", Arrays.copyOf(`baseText$iv`, `baseText$iv`.length))
               ...
               var var10003: MutableComponent = Component.translatable("nrc.moderation.report.select_category", Arrays.copyOf(`args$ivx`, `args$ivx`.length))
               ...
               for (var35 in ReportScreen.ReportReason.getEntries()) {
                  val var38: NrcLabelButton = NrcLabelButton(
                     TextKt.toSmallCaps(var35.displayName), { var4: NrcLabelButton, var5: Double, var7: Double, var9: Int ->
               ...
               dialog.getCloseButton().onClick({ var0: NrcLabelButton, var1: Double, var3: Double, var5: Int ->
   ...
   private fun showReasonInput(root: FlowLayout, oldDialog: NrcDialog, reason: gg.norisk.client.v2.moderation.ui.ReportScreen.ReportReason) {
      oldDialog.close()
      root.clearChildren()
      NrcDialog.Companion
         .openConfirmDialogNoEscape(
            ...
            { dialog: NrcDialog, overlay: OverlayContainer ->
               ...
               var var10001: MutableComponent = Component.translatable("nrc.moderation.report.title_with_reason", Arrays.copyOf(var16, var16.length))
               var10001 = var10001.withColor(ThemeModule.INSTANCE.getFontColor().getRGB())
               var10000.text(var10001 as Component)
               val inputField: NrcInputField = NrcInputField(230, "", 0.0F, false, 12, null)
               ...
               var18.gap(3)
               val `args$ivx`: Array<Any> = arrayOfNulls(0)
               var var10003: MutableComponent = Component.translatable("nrc.moderation.report.enter_reason", Arrays.copyOf(`args$ivx`, `args$ivx`.length))
               var10003 = var10003.withColor(ThemeModule.INSTANCE.getFontColor().getRGB())
               ...
               dialog.getCancelButton().onClick({ var1: NrcLabelButton, var2: Double, var4: Double, var6: Int ->
                  UISounds.playButtonSound()
               ...
               dialog.getConfirmButton()
                  .onClick(
                     { var4: NrcLabelButton, var5: Double, var7: Double, var9: Int ->
                        val text: java.lang.String = StringsKt.trim(`$inputField`.getText()).toString()
                        if (text.length() == 0) {
                           ...
                           val var10000: MutableComponent = Component.translatable(
                              "nrc.moderation.report.reason_required", Arrays.copyOf(`inheritStyle$iv`, `inheritStyle$iv`.length)
                           )
   ...
   private fun submitReport(reason: gg.norisk.client.v2.moderation.ui.ReportScreen.ReportReason, text: String) {
