...
public abstract class QuietPackMetadataMixin {
   ...
   private static boolean nrc$dropError2(Logger logger, String format, Object a, Object b) {
   ...
   private static boolean nrc$dropErrorVar(Logger logger, String format, Object[] args) {
      if (PackLogReroute.shouldDrop()) {
   ...
   private static DataResult<?> nrc$skipIfError(DataResult<?> result, Consumer<?> consumer, Operation<DataResult<?>> original) {
      if (PackLogReroute.shouldDrop()) {
