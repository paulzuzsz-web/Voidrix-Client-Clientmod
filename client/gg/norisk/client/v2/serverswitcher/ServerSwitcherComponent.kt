...
public class ServerSwitcherComponent(parentScreen: Screen) : FlowLayout(Sizing.Companion.fixed(20), Sizing.Companion.fixed(20), Algorithm.HORIZONTAL) {
   ...
   init {
      ...
      this.surface(gg.norisk.owolib.owo.ui.core.Surface.Companion.vanillaButton$default(Surface.Companion, null, { 
         `$hovered`.element
      }, 1, null))
      ...
      val var10001: MutableComponent = Component.translatable("nrc.ui.pause.serverSwitcher", Arrays.copyOf(`args$iv`, `args$iv`.length))
   ...
   @JvmStatic
   fun {
      val var10000: Identifier = Identifier.fromNamespaceAndPath("nrc-ui", "textures/icon/globe.png")
      GLOBE = var10000
   }
