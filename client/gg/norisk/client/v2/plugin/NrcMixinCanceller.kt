...
@SourceDebugExtension(["SMAP\nNrcMixinCanceller.kt\nKotlin\n*S Kotlin\n*F\n+ 1 NrcMixinCanceller.kt\ngg/norisk/client/v2/plugin/NrcMixinCanceller\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,108:1\n1761#2,3:109\n*S KotlinDebug\n*F\n+ 1 NrcMixinCanceller.kt\ngg/norisk/client/v2/plugin/NrcMixinCanceller\n*L\n34#1:109,3\n*E\n"])
public class NrcMixinCanceller : MixinCanceller {
   ...
   @SourceDebugExtension(["SMAP\nNrcMixinCanceller.kt\nKotlin\n*S Kotlin\n*F\n+ 1 NrcMixinCanceller.kt\ngg/norisk/client/v2/plugin/NrcMixinCanceller$Companion\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,108:1\n1869#2,2:109\n*S KotlinDebug\n*F\n+ 1 NrcMixinCanceller.kt\ngg/norisk/client/v2/plugin/NrcMixinCanceller$Companion\n*L\n97#1:109,2\n*E\n"])
   public companion object {
      private final val logger: Logger
      private final val json: Json
      private const val CONFIG_NAMESPACE: String = "noriskclient"
      ...
      private fun ensureConfigLoaded() {
         if (NrcMixinCanceller.configLoadAttempted.compareAndSet(false, true)) {
            this.loadConfig()
      ...
      private fun loadConfig() {
         val e: NrcMixinCanceller.Companion = this

         var `$this$loadConfig_u24lambda_u240`: NrcMixinCanceller.Companion
         try {
            `$this$loadConfig_u24lambda_u240` = e
            `$this$loadConfig_u24lambda_u240` = (NrcMixinCanceller.Companion)Result.constructor_impl/* $VF was: constructor-impl */(
               NrcAssetReader.tryReadBytesFromCache$default(NrcAssetReader.INSTANCE, "noriskclient", "mixin_cancellor.json", null, null, 12, null)
            )
         ...
         if (bytes == null) {
            NrcMixinCanceller.logger.info("MixinCanceller config not found at noriskclient:mixin_cancellor.json — using defaults")
         } else {
            try {
               this.config = NrcMixinCanceller.json
               ...
               NrcMixinCanceller.logger.info("Loaded MixinCanceller config from noriskclient:mixin_cancellor.json")
            } catch (var5: Exception) {
               NrcMixinCanceller.logger.error("Failed to parse MixinCanceller config from noriskclient:mixin_cancellor.json: ${var5.getMessage()}", var5)
            }
         }
      }
      ...
      private fun updatePackagePatterns() {
         ...
         for (`element$iv` in this.config.cancelledMixinPackages) {
            ...
            try {
               val var10000: java.util.List = NrcMixinCanceller.Companion.packagePatterns
               val var10001: Pattern = Pattern.compile(regex)
               var10000.add(var10001)
            } catch (var8: PatternSyntaxException) {
               NrcMixinCanceller.logger.error("Invalid regex in MixinCanceller config: '${`element$iv` as java.lang.String}' - ${var8.getMessage()}")
            }
         }
      }
   }
