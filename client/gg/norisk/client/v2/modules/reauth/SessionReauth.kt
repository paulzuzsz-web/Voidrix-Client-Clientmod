package gg.norisk.client.v2.modules.reauth
...
import gg.norisk.ui.v2.toast.NrcLoadingToast
...
public object SessionReauth {
   ...
   public fun buttonText(): String {
      ...
      val var10000: MutableComponent = Component.translatable("nrc.ui.reauth.button", Arrays.copyOf(`$i$f$asString`, `$i$f$asString`.length))
   ...
   public fun triggerReauth() {
      if (running.compareAndSet(false, true)) {
         val var10000: NrcLoadingToast = NrcLoadingToast.INSTANCE
         val `$i$f$asString`: Array<Any> = arrayOfNulls(0)
         val var10001: MutableComponent = Component.translatable("nrc.ui.reauth.refreshing", Arrays.copyOf(`$i$f$asString`, `$i$f$asString`.length))
