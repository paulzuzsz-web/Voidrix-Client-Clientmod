...
import gg.norisk.compat.v2.hud.HudManager
...
import gg.norisk.ui.components.modules.DraggableModuleEditWrapper
...
import gg.norisk.ui.modules.v3.V3ModuleSettingsPanel
...
public class KeystrokeLayoutEditorScreen : BaseOwoScreen(null, 1), INRCScreen {
   ...
   private fun buildNavbar(): FlowLayout {
      ...
      val var10000: MutableComponent = Component.translatable("nrc.ui.modules.value.keystrokes", Arrays.copyOf(var28, var28.length))
   ...
   private fun buildFooter(): FlowLayout {
      ...
      val var10003: MutableComponent = Component.translatable(
         "nrc.ui.modules.keystrokes.designer",
   ...
   private fun buildPresetRow(): FlowLayout {
      ...
      for (`$this$buildPresetRow_u24lambda_u2449_u24lambda_u2448` in KeystrokePresets.INSTANCE.all) {
         `$this$buildPresetRow_u24lambda_u2449`.child(this.presetChip(`$this$buildPresetRow_u24lambda_u2449_u24lambda_u2448`.displayName, { 
            ...
            if (KeystrokePresets.INSTANCE.cpsPresets.contains(`$preset`.id)) {
               Keystrokes.INSTANCE.setShowCps$nrc_client(true)
            }
      ...
      val var10003: MutableComponent = Component.translatable("nrc.ui.modules.keystrokes.presets", Arrays.copyOf(var14, var14.length))
   ...
   private fun presetChip(name: String, onClick: () -> Unit): V3Button {
      ...
      val var6: V3Button = V3Button(var10002, { var1: NrcLabelButton, var2: Double, var4: Double, var6: Int ->
         MCSounds.INSTANCE.playButtonSound()
         `$onClick`()
         Unit.INSTANCE
      })
   ...
   private fun buildSlider(label: String, min: Double, max: Double, initial: Double, stepSize: Double, decimals: Int, onChange: (Double) -> Unit): FlowLayout {
      ...
      val var19: NrcSliderWithInput = NrcSliderWithInput(min, max, initial, null, stepSize, false, 120, 26, decimals, 0.0F, 0.0F, 1576, null)
   ...
   private fun rebuildProperties() {
      ...
      if (selected == null) {
         ...
         var16.gap(4)
         var var7: V3Button = V3Button("unbind", { var1: NrcLabelButton, var2: Double, var4: Double, var6: Int ->
            var var10000: KeystrokeGridEditor = `this$0`.editor
            if (`this$0`.editor == null) {
               Intrinsics.throwUninitializedPropertyAccessException("editor")
               var10000 = null
         ...
         var7 = V3Button("delete", { var1: NrcLabelButton, var2: Double, var4: Double, var6: Int ->
            var var10000: KeystrokeGridEditor = `this$0`.editor
            if (`this$0`.editor == null) {
               Intrinsics.throwUninitializedPropertyAccessException("editor")
               var10000 = null
