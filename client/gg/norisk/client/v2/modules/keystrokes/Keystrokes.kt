...
import gg.norisk.client.v2.modules.cps.CPS
...
import gg.norisk.ui.api.value.GenericValue
...
import gg.norisk.ui.v2.hud.Background.CornerStyle
...
public object Keystrokes : AbstractHud("Keystrokes", false, false, false, 14), IContentBackground {
   ...
   private final var keyWrapper: gg.norisk.client.v2.modules.keystrokes.Keystrokes.GridKeyWrapper?
   internal final var designerPreviewWrapper: gg.norisk.client.v2.modules.keystrokes.Keystrokes.GridKeyWrapper?
   internal final var designerScreenOpen: Boolean

   private final var storedLayout: gg.norisk.client.v2.modules.keystrokes.Keystrokes.StoredLayout
      private final get() {
   ...
   private fun defaultStoredLayout(): gg.norisk.client.v2.modules.keystrokes.Keystrokes.StoredLayout {
      ...
      return lambda_18@{ settingsPanel: FlowLayout ->
         if (designerScreenOpen) {
            ...
            val var10003: MutableComponent = Component.translatable(
               "nrc.ui.modules.keystrokes.customize",
               Arrays.copyOf(
            ...
            val var11: V3Button = V3Button(var15, { var1: NrcLabelButton, var2: Double, var4: Double, var6: Int ->
               `$openEditor`()
               Unit.INSTANCE
            })
   ...
   @SourceDebugExtension(["SMAP\nKeystrokes.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Keystrokes.kt\ngg/norisk/client/v2/modules/keystrokes/Keystrokes$GridKeyWrapper\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,691:1\n1#2:692\n*E\n"])
   internal class GridKeyWrapper : FlowLayout(Sizing.Companion.content(), Sizing.Companion.content(), Algorithm.VERTICAL) {
      private final val keyComps: MutableList<gg.norisk.client.v2.modules.keystrokes.Keystrokes.SimpleKeyComponent> = ArrayList() as java.util.List
         ...
         if (!children.isEmpty()) {
            for (c in children) {
               if (c is Keystrokes.SimpleKeyComponent) {
                  (c as Keystrokes.SimpleKeyComponent).drawSurface$nrc_client(context, mouseX, mouseY, partialTicks, delta)
               }
            }
            ...
            for (var11 in children) {
               if (var11 is Keystrokes.SimpleKeyComponent) {
                  (var11 as Keystrokes.SimpleKeyComponent).drawPressOverlay$nrc_client(context)
               }
            }
            ...
            for (var12 in children) {
               if (var12 is Keystrokes.SimpleKeyComponent) {
                  (var12 as Keystrokes.SimpleKeyComponent).drawForeground$nrc_client(context, mouseX, mouseY, partialTicks, delta)
               }
            }
         }
      }
      ...
      public fun getKeyComponents(): List<gg.norisk.client.v2.modules.keystrokes.Keystrokes.SimpleKeyComponent> {
         return this.keyComps
      }
   }

   @SourceDebugExtension(["SMAP\nKeystrokes.kt\nKotlin\n*S Kotlin\n*F\n+ 1 Keystrokes.kt\ngg/norisk/client/v2/modules/keystrokes/Keystrokes$SimpleKeyComponent\n+ 2 MCClient.kt\ngg/norisk/compat/client/MCClient\n+ 3 MCClient.kt\ngg/norisk/compat/client/MCClientKt\n+ 4 TextBuilder.kt\ngg/norisk/compat/text/TextBuilderKt\n+ 5 TextBuilder.kt\ngg/norisk/compat/text/LiteralTextBuilder\n*L\n1#1,691:1\n40#2:692\n127#2:693\n40#2:694\n239#2:696\n40#2:697\n941#3:695\n941#3:713\n8#4,4:698\n78#5,6:702\n72#5,4:708\n87#5:712\n*S KotlinDebug\n*F\n+ 1 Keystrokes.kt\ngg/norisk/client/v2/modules/keystrokes/Keystrokes$SimpleKeyComponent\n*L\n423#1:692\n477#1:693\n477#1:694\n490#1:696\n490#1:697\n478#1:695\n507#1:713\n502#1:698,4\n502#1:702,6\n502#1:708,4\n502#1:712\n*E\n"])
   internal class SimpleKeyComponent(key: MCKey, horizontalSizing: Sizing, verticalSizing: Sizing) : FlowLayout(
      ...
      public open fun draw(context: OwoUIGraphics, mouseX: Int, mouseY: Int, partialTicks: Float, delta: Float) {
         this.drawSurface$nrc_client(context, mouseX, mouseY, partialTicks, delta)
         this.drawPressOverlay$nrc_client(context)
         this.drawForeground$nrc_client(context, mouseX, mouseY, partialTicks, delta)
      }
   ...
   internal data class StoredKey(x: Int, y: Int, w: Int, h: Int, keyName: String) {
      ...
      public fun copy(x: Int = this.x, y: Int = this.y, w: Int = this.w, h: Int = this.h, keyName: String = this.keyName): gg.norisk.client.v2.modules.keystrokes.Keystrokes.StoredKey {
      ...
      public companion object {
         public fun serializer(): KSerializer<gg.norisk.client.v2.modules.keystrokes.Keystrokes.StoredKey> {
   ...
   @Serializable
   internal data class StoredLayout(keys: List<gg.norisk.client.v2.modules.keystrokes.Keystrokes.StoredKey> = CollectionsKt.emptyList()) {
      public final val keys: List<gg.norisk.client.v2.modules.keystrokes.Keystrokes.StoredKey>
      @JvmField
      @JvmStatic
      ...
      public operator fun component1(): List<gg.norisk.client.v2.modules.keystrokes.Keystrokes.StoredKey> {
         return this.keys
      }

      public fun copy(keys: List<gg.norisk.client.v2.modules.keystrokes.Keystrokes.StoredKey> = this.keys): gg.norisk.client.v2.modules.keystrokes.Keystrokes.StoredLayout {
      ...
      public companion object {
         public fun serializer(): KSerializer<gg.norisk.client.v2.modules.keystrokes.Keystrokes.StoredLayout> {
