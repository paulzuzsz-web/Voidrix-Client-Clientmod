...
import gg.norisk.owolib.owo.ui.inject.GreedyInputComponent
...
private class PressToBindButton(initialKey: MCKey, onBind: (MCKey) -> Unit, autoStartListening: Boolean = false) : NrcLabelButton(
   ...
   init {
      ...
      this.onPress({ var1: NrcLabelButton, var2: Double, var4: Double, button: Int ->
