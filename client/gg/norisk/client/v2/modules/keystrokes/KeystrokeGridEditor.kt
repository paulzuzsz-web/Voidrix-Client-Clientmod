...
public class KeystrokeGridEditor(gridCols: Int = 30, gridRows: Int = 16, cellSizePx: Int = 8, dotEveryN: Int = 2) : BaseUIComponent {
   ...
   private final var mode: gg.norisk.client.v2.modules.keystrokes.KeystrokeGridEditor.Mode
   ...
   private final var resizeHandle: gg.norisk.client.v2.modules.keystrokes.KeystrokeGridEditor.Handle
   ...
   private fun hitHandle(relX: Double, relY: Double, key: PlacedKey): gg.norisk.client.v2.modules.keystrokes.KeystrokeGridEditor.Handle? {
