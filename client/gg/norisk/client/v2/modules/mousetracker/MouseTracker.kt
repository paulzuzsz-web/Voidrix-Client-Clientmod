package gg.norisk.client.v2.modules.mousetracker

import gg.norisk.client.v2.modules.cps.CPS
import gg.norisk.compat.event.MouseEvents
import gg.norisk.compat.event.MouseMoveEventData
...
public object MouseTracker : AbstractHud("MouseTracker", false, false, false, 14), IContentBackground {
   ...
   @Category(name = "Display")
   @NotNull
   public final val shape: gg.norisk.client.v2.modules.mousetracker.MouseTracker.Shape by ValueApiKt.enum$default(
   ...
   public open fun onEnable() {
      ...
      if (var10000.player != null) {
         ...
         val var21: MutableComponent = Component.translatable(
            "nrc.ui.modules.mousetracker.toast.title", Arrays.copyOf(`inheritStyle$iv`, `inheritStyle$iv`.length)
         )
         ...
         val var10001: MutableComponent = Component.translatable("nrc.ui.modules.mousetracker.toast.warning", Arrays.copyOf(`args$ivx`, `args$ivx`.length))
   ...
   @SourceDebugExtension(["SMAP\nMouseTracker.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MouseTracker.kt\ngg/norisk/client/v2/modules/mousetracker/MouseTracker$ArenaComponent\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,317:1\n1740#2,3:318\n*S KotlinDebug\n*F\n+ 1 MouseTracker.kt\ngg/norisk/client/v2/modules/mousetracker/MouseTracker$ArenaComponent\n*L\n233#1:318,3\n*E\n"])
   ...
   @SourceDebugExtension(["SMAP\nMouseTracker.kt\nKotlin\n*S Kotlin\n*F\n+ 1 MouseTracker.kt\ngg/norisk/client/v2/modules/mousetracker/MouseTracker$CpsLabelComponent\n+ 2 MCClient.kt\ngg/norisk/compat/client/MCClient\n+ 3 MCClient.kt\ngg/norisk/compat/client/MCClientKt\n*L\n1#1,317:1\n127#2:318\n40#2:319\n941#3:320\n940#3:321\n*S KotlinDebug\n*F\n+ 1 MouseTracker.kt\ngg/norisk/client/v2/modules/mousetracker/MouseTracker$CpsLabelComponent\n*L\n306#1:318\n306#1:319\n308#1:320\n310#1:321\n*E\n"])
   ...
   internal class TrackerComponent : FlowLayout(Sizing.Companion.content(), Sizing.Companion.content(), Algorithm.VERTICAL) {
      private final val arena: gg.norisk.client.v2.modules.mousetracker.MouseTracker.ArenaComponent = MouseTracker.ArenaComponent()
      private final val cpsLabel: gg.norisk.client.v2.modules.mousetracker.MouseTracker.CpsLabelComponent = MouseTracker.CpsLabelComponent()
