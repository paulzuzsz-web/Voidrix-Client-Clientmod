...
import gg.norisk.compat.client.MCParticles
...
public object ParticleSettingsComponent {
   ...
   public fun build(settingsPanel: FlowLayout, module: ParticleModule) {
      ...
      var var10002: MutableComponent = Component.translatable("nrc.particle.button.all_on", Arrays.copyOf(listChild, listChild.length))
      val var32: java.lang.String = (TextKt.toSmallCapsText(var10002 as Component) as Component).getString()
      val var13: NrcLabelButton = NrcLabelButton(var32, { var2: NrcLabelButton, var3: Double, var5: Double, var7: Int ->
      ...
      var10002 = Component.translatable("nrc.particle.button.all_off", Arrays.copyOf(`args$ivx`, `args$ivx`.length))
      val var34: java.lang.String = (TextKt.toSmallCapsText(var10002 as Component) as Component).getString()
      val var19: NrcLabelButton = NrcLabelButton(var34, { var2: NrcLabelButton, var3: Double, var5: Double, var7: Int ->
         UISounds.playButtonSound()
   ...
   private fun buildParticleRow(typeId: String, module: ParticleModule): FlowLayout {
      ...
      val var29: NrcCheckbox = NrcCheckbox(0.7F)
      ...
      if (var24) {
         ...
         val var32: NrcSliderWithInput = NrcSliderWithInput(0.0, 10.0, settings.multiplier, 1.0, 0.05, true, 50, 24, 2, 0.65F, 0.55F)
         ...
         var34.title("Scale")
         val var35: NrcSliderWithInput = NrcSliderWithInput(0.25, 3.0, settings.scale, 1.0, 0.05, true, 50, 24, 2, 0.65F, 0.55F)
         ...
         val var10001: MutableComponent = Component.translatable("nrc.particle.value.spawnOnHit", Arrays.copyOf(`$i$f$asString`, `$i$f$asString`.length))
         val var41: java.lang.String = (var10001 as Component).getString()
         var37.title(var41)
         val var39: NrcCheckbox = NrcCheckbox(0.7F)
