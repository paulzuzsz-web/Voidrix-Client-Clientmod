...
public class ItemCounterComponent(dto: ItemCounterDto) : FlowLayout(Sizing.Companion.content(), Sizing.Companion.content(), Algorithm.VERTICAL) {
   ...
   public final val itemComponent: gg.norisk.client.v2.modules.itemcounter.ItemCounterComponent.ItemStackComponent
   ...
   @SourceDebugExtension(["SMAP\nItemCounterComponent.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ItemCounterComponent.kt\ngg/norisk/client/v2/modules/itemcounter/ItemCounterComponent$ItemStackComponent\n+ 2 MCClient.kt\ngg/norisk/compat/client/MCClient\n*L\n1#1,98:1\n185#2:99\n40#2:100\n127#2:101\n40#2:102\n*S KotlinDebug\n*F\n+ 1 ItemCounterComponent.kt\ngg/norisk/client/v2/modules/itemcounter/ItemCounterComponent$ItemStackComponent\n*L\n77#1:99\n77#1:100\n83#1:101\n83#1:102\n*E\n"])
   public inner class ItemStackComponent(stack: ItemStack, itemId: Identifier) : NrcItemComponent(stack) {
