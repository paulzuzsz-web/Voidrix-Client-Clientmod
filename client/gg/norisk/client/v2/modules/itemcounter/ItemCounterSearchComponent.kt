...
public class ItemCounterSearchComponent(horizontalSizing: Sizing = Sizing.Companion.fill(), verticalSizing: Sizing = Sizing.Companion.content()) : FlowLayout(
   ...
   @JvmStatic
   fun `_init_$addItem`(`this$0`: ItemCounterSearchComponent, searchField: NrcInputField, id: Identifier, root: ParentUIComponent) {
   ...
   @JvmStatic
   fun `_init_$openDropdown`(`this$0`: ItemCounterSearchComponent, searchField: NrcInputField) {
      `this$0`.closeDropdown()
