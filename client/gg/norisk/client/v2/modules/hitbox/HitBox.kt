...
public object HitBox : Module("Hitbox", ModuleCategory.VISUAL, false, false, false, 28) {
   ...
   private final val defaultSettings: Map<String, gg.norisk.client.v2.modules.hitbox.HitBox.HitBoxSettings>

   public final var settings: MutableMap<String, gg.norisk.client.v2.modules.hitbox.HitBox.HitBoxSettings>
      public final get() {
   ...
   public fun getSettings(type: gg.norisk.client.v2.modules.hitbox.HitBox.Type): gg.norisk.client.v2.modules.hitbox.HitBox.HitBoxSettings {
   ...
   @JvmStatic
   public fun getEffectiveColor(entity: Any, settings: gg.norisk.client.v2.modules.hitbox.HitBox.HitBoxSettings): Color {
   ...
   public data class HitBoxSettings(visible: Boolean = true,
      ...
      facingColor: MultiColor = MultiColor(gg.norisk.owolib.owo.ui.core.Color.Companion.ofArgb(-16776961), false, false, 6, null),
      showLookVector: Boolean = false,
      dynamicColor: Boolean = false,
      enemyColor: MultiColor = MultiColor(gg.norisk.owolib.owo.ui.core.Color.Companion.ofArgb(-65536), false, false, 6, null)
   ) {
      ...
      public fun deepCopy(): gg.norisk.client.v2.modules.hitbox.HitBox.HitBoxSettings {
         return copy$default(
            this,
            false,
            0.0F,
      ...
      ): gg.norisk.client.v2.modules.hitbox.HitBox.HitBoxSettings {
      ...
      public companion object {
         public fun serializer(): KSerializer<gg.norisk.client.v2.modules.hitbox.HitBox.HitBoxSettings> {
   ...
   public enum class Type(displayName: String) {
      ...
      @SourceDebugExtension(["SMAP\nHitBox.kt\nKotlin\n*S Kotlin\n*F\n+ 1 HitBox.kt\ngg/norisk/client/v2/modules/hitbox/HitBox$Type$Companion\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 3 MCClient.kt\ngg/norisk/compat/client/MCClient\n*L\n1#1,669:1\n1#2:670\n185#3:671\n40#3:672\n*S KotlinDebug\n*F\n+ 1 HitBox.kt\ngg/norisk/client/v2/modules/hitbox/HitBox$Type$Companion\n*L\n106#1:671\n106#1:672\n*E\n"])
      public companion object {
         public fun classify(entity: Any): gg.norisk.client.v2.modules.hitbox.HitBox.Type? {
