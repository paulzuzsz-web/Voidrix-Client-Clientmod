...
import gg.norisk.owolib.owo.ui.component.ConditionalComponent
...
@SourceDebugExtension(["SMAP\nHitBoxSettingsComponent.kt\nKotlin\n*S Kotlin\n*F\n+ 1 HitBoxSettingsComponent.kt\ngg/norisk/client/v2/modules/hitbox/HitBoxSettingsComponent\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,198:1\n1869#2,2:199\n*S KotlinDebug\n*F\n+ 1 HitBoxSettingsComponent.kt\ngg/norisk/client/v2/modules/hitbox/HitBoxSettingsComponent\n*L\n56#1:199,2\n*E\n"])
public object HitBoxSettingsComponent {
   private final val collapsibles: ArrayList<NrcCollapsibleContainer> = ArrayList()
            ...
            public open fun toggleExpansion() {
               ...
               if (this.expanded()) {
                  for (`element$iv` in HitBoxSettingsComponent.collapsibles) {
                     val it: NrcCollapsibleContainer = `element$iv` as NrcCollapsibleContainer
                     if (`element$iv` as NrcCollapsibleContainer != this && (`element$iv` as NrcCollapsibleContainer).expanded()) {
                        it.toggleExpansion()
                     }
                  }
   ...
   private fun buildTypeSettings(module: HitBox, type: Type): FlowLayout {
      ...
      val visibleCheckbox: NrcCheckbox = NrcCheckbox(0.75F)
      ...
      val colorLine: NrcSliderWithInput = NrcSliderWithInput(0.5, 10.0, settings.lineWidth, 1.0, 0.5, false, 0, 0, 1, 0.0F, 0.0F, 1760, null)
      ...
      if (type != HitBox.Type.SELF) {
         ...
         val lookVectorCheckbox: NrcCheckbox = NrcCheckbox(0.75F)
      ...
      val var19: NrcCheckbox = NrcCheckbox(0.75F)
