...
import gg.norisk.ui.components.NonCenteredOverlayContainer
...
import gg.norisk.ui.versionless.DrawContextVersionlessKt
...
@SourceDebugExtension(["SMAP\nItemHighlighterSearchComponent.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ItemHighlighterSearchComponent.kt\ngg/norisk/client/v2/modules/itemhighlighter/ItemHighlighterSearchComponent\n+ 2 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n+ 3 Text.kt\ngg/norisk/compat/text/TextKt\n*L\n1#1,167:1\n1869#2:168\n1870#2:170\n269#3:169\n*S KotlinDebug\n*F\n+ 1 ItemHighlighterSearchComponent.kt\ngg/norisk/client/v2/modules/itemhighlighter/ItemHighlighterSearchComponent\n*L\n73#1:168\n73#1:170\n77#1:169\n*E\n"])
public class ItemHighlighterSearchComponent(horizontalSizing: Sizing = Sizing.Companion.fill(), verticalSizing: Sizing = Sizing.Companion.content()) : FlowLayout(
   ...
   init {
      val var4: NrcInputField = NrcInputField(120, "", 0.75F, true)
   ...
   @JvmStatic
   fun `_init_$addItem`(`this$0`: ItemHighlighterSearchComponent, searchField: NrcInputField, id: Identifier, root: ParentUIComponent) {
      ItemHighlighter.INSTANCE.add(id, root)
      `this$0`.closeDropdown()
      searchField.text("")
   }

   @JvmStatic
   fun `_init_$openDropdown`(`this$0`: ItemHighlighterSearchComponent, searchField: NrcInputField) {
      `this$0`.closeDropdown()
      ...
      if (searchText.length() != 0) {
         ...
         if (!results.isEmpty()) {
            ...
            for (`$this$openDropdown_u24lambda_u2416` in results) {
               ...
               try {
                  ...
                  var48.mouseDown().subscribe(lambda_13_lambda_12_lambda_6@{ var4: MouseButtonEvent, var5: Boolean ->
                     ...
                     if (ItemHighlighter.INSTANCE.items.containsKey(`$id`)) {
                        val var10000: ItemHighlighterDto = ItemHighlighter.INSTANCE.items.get(`$id`)
                        if (var10000 == null) {
                           return@lambda_13_lambda_12_lambda_6 true
                        }

                        val var7: ItemHighlighter = ItemHighlighter.INSTANCE
                  ...
                  val var52: Boolean = ItemHighlighter.INSTANCE.items.containsKey(id)
            ...
            DrawContextVersionlessKt.nrcZIndex(var39 as UIComponent, 8000)
   ...
   fun ItemHighlighterSearchComponent() {
