...
import gg.norisk.owolib.owo.ui.component.ButtonComponent
...
import gg.norisk.ui.api.serializable.SoundAttribute
import gg.norisk.ui.api.value.AnchorPositionValueKt
...
public object DummyModule : Module("Dummy Module", ModuleCategory.VISUAL, true, false, false) {
   ...
   @Category(name = "Enums")
   @NotNull
   public final val testEnum: gg.norisk.client.v2.modules.impl.DummyModule.TestMode by ValueApiKt.enum$default(
   ...
   public final val filteredEnum: gg.norisk.client.v2.modules.impl.DummyModule.TestMode by ValueApiKt.enum$default(
   ...
   public final val backgroundAttr: Background by ValueApiKt.generic$default({ 
      ...
      parent.child(NrcBackgroundPicker(INSTANCE.backgroundAttr, null) as UIComponent)
      true
   ...
   public final val multiColorAttr: MultiColor by ValueApiKt.generic$default({ 
      ...
      parent.child(NrcMultiColorPicker(INSTANCE.multiColorAttr, null, null, null, 12, null) as UIComponent)
      true
