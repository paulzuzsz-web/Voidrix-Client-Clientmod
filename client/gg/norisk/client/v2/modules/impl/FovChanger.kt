...
import gg.norisk.compat.client.MCCamera
import gg.norisk.compat.client.MCLivingEntityKt
...
import gg.norisk.ui.components.nrc.NrcValueLine
import gg.norisk.ui.config.profile.Profile
...
public object FovChanger : Module("Fov Changer", ModuleCategory.PVP, false, false, false, 20) {
   ...
   public final var syncedMinecraftValues: gg.norisk.client.v2.modules.impl.FovChanger.SyncedMinecraftValues
      public final get() {
   ...
   public open fun buildCustomUi(): (FlowLayout) -> Unit {
      return lambda_15@{ settingsPanel: FlowLayout ->
         ...
         for (`element$iv$iv` in `$this$buildCustomUi_u24lambda_u2415_u24lambda_u2414`) {
            if (`element$iv$iv` is NrcCollapsibleContainer) {
               var6.add(`element$iv$iv`)
            }
         }

         val var10000: NrcCollapsibleContainer = CollectionsKt.firstOrNull(var6 as java.util.List) as NrcCollapsibleContainer
         if (var10000 == null) {
            return@lambda_15 Unit.INSTANCE
         } else {
            val fovLine: NrcValueLine = NrcValueLine(Sizing.Companion.fill(95), Sizing.Companion.content())
            fovLine.title("Default Fov")
            var var10005: java.lang.Number = Minecraft.getInstance()
            val var12: NrcSliderWithInput = NrcSliderWithInput(
            ...
            val var14: NrcValueLine = NrcValueLine(Sizing.Companion.fill(95), Sizing.Companion.content())
            ...
            val var18: NrcSliderWithInput = NrcSliderWithInput(0.0, 1.0, var10005.doubleValue(), 1.0, 0.01, false, 0, 0, 2, 0.0F, 0.0F, 1760, null)
      ...
      Profile.Companion.getPROFILE_LOADED_EVENT().listen(lambda_5@{ profile: Profile ->
         ...
         if (var10000.options == null) {
            ...
            if (var22 != null) {
               ...
               val `$i$f$nrcDebug`: Double = var12
               var10000 = Minecraft.getInstance()
               var10000.options.fov().set((int)`$i$f$nrcDebug`)
            }
   ...
   public data class SyncedMinecraftValues(fov: Int? = null, fovEffects: Double? = null) {
      ...
      public fun copy(fov: Int? = this.fov, fovEffects: Double? = this.fovEffects): gg.norisk.client.v2.modules.impl.FovChanger.SyncedMinecraftValues {
      ...
      public companion object {
         public fun serializer(): KSerializer<gg.norisk.client.v2.modules.impl.FovChanger.SyncedMinecraftValues> {
