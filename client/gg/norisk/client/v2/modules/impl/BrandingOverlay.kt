...
import gg.norisk.owolib.owo.ui.core.OwoUIGraphicsImpl
...
val scaledScreenHeight: Double = screenHeight / (float)(1.0 / var10000 * 3.0)
   ...
   @JvmStatic
   fun {
      val var10000: Identifier = Identifier.fromNamespaceAndPath("nrc-client", "textures/noriskclient-logo-text.png")
