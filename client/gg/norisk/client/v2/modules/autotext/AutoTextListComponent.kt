...
import gg.norisk.ui.components.nrc.NrcConfirmDialog
...
public class AutoTextListComponent(horizontalSizing: Sizing = Sizing.Companion.fill(), verticalSizing: Sizing = Sizing.Companion.content()) : FlowLayout(
   ...
   private fun buildEmptyState(): UIComponent {
      ...
      var var10003: MutableComponent = Component.translatable("nrc.autotext.empty.title", Arrays.copyOf(var10, var10.length))
      ...
      var10003 = Component.translatable("nrc.autotext.empty.subtitle", Arrays.copyOf(var10, var10.length))
   ...
   @SourceDebugExtension(["SMAP\nAutoTextListComponent.kt\nKotlin\n*S Kotlin\n*F\n+ 1 AutoTextListComponent.kt\ngg/norisk/client/v2/modules/autotext/AutoTextListComponent$AutoTextEntryCard\n+ 2 Text.kt\ngg/norisk/compat/text/TextKt\n*L\n1#1,169:1\n67#2:170\n269#2:171\n67#2:172\n269#2:173\n67#2:174\n269#2:175\n67#2:176\n67#2:177\n*S KotlinDebug\n*F\n+ 1 AutoTextListComponent.kt\ngg/norisk/client/v2/modules/autotext/AutoTextListComponent$AutoTextEntryCard\n*L\n97#1:170\n97#1:171\n116#1:172\n116#1:173\n128#1:174\n128#1:175\n139#1:176\n141#1:177\n*E\n"])
   public inner class AutoTextEntryCard(entry: AutoTextEntry) : FlowLayout(Sizing.Companion.fill(), Sizing.Companion.content(), Algorithm.VERTICAL) {
      ...
      private final val collapsible: NrcCollapsibleContainer
      ...
      init {
         ...
         var var32: MutableComponent = Component.translatable("nrc.autotext.field.message", Arrays.copyOf(`$i$f$asString`, `$i$f$asString`.length))
         val var33: java.lang.String = (var32 as Component).getString()
         var12.title(var33)
         val var23: NrcInputField = NrcInputField(140, this.entry.text, 0.75F, true)
         ...
         var32 = Component.translatable("nrc.autotext.field.keybind", Arrays.copyOf(`$i$f$asString`, `$i$f$asString`.length))
      ...
      private fun entryTitleText(): String {
         ...
         if (raw.length() == 0) {
            ...
            val var10000: MutableComponent = Component.translatable("nrc.autotext.entry.untitled", Arrays.copyOf(`$i$f$asString`, `$i$f$asString`.length))
      ...
      private fun confirmDelete() {
         ...
         if (var10000 != null) {
            NrcConfirmDialog.Companion.openConfirmDialog(var10000, { dialog: NrcConfirmDialog ->
               val var10000: LabelComponent = dialog.getTitle()
               var `args$iv`: Array<Any> = arrayOfNulls(0)
               val var10001: MutableComponent = Component.translatable("nrc.autotext.delete.title", Arrays.copyOf(`args$iv`, `args$iv`.length))
               var10000.text(var10001 as Component)
               `args$iv` = arrayOf(`this$0`.entryTitleText())
               val var10003: MutableComponent = Component.translatable("nrc.autotext.delete.message", Arrays.copyOf(`args$iv`, `args$iv`.length))
               dialog.content(LabelComponent(var10003 as Component) as UIComponent)
               dialog.getConfirmButton().onClick({ var3: NrcLabelButton, var4: Double, var6: Double, var8: Int ->
                  UISounds.playButtonSound()
