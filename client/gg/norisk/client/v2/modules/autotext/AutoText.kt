...
public object AutoText : Module("AutoText", ModuleCategory.QUALITY_OF_LIFE, false, true, false, 20) {
   ...
   public final var keybinds: MutableList<AutoTextEntry> by ValueApiKt.list$default(
         { 
            CollectionsKt.mutableListOf(
               arrayOf(
                  AutoTextEntry(null, "noriskclient ooooooon top", null, false, 13, null),
                  AutoTextEntry(null, "/command", null, false, 13, null),
                  AutoTextEntry(null, "/nrc minigames tetris computer", null, false, 13, null),
                  AutoTextEntry(null, "/nrc flappybird", null, false, 13, null)
               )
            )
         },
   ...
   public open fun buildCustomUi(): (FlowLayout) -> Unit {
      return { settingsPanel: FlowLayout ->
         ...
         val var10003: MutableComponent = Component.translatable("nrc.autotext.button.add", Arrays.copyOf(var11, var11.length))
         val var19: java.lang.String = (var10003 as Component).getString()
         val var9: V3Button = V3Button("+ ${TextKt.toSmallCaps(var19)}", { var1: NrcLabelButton, var2: Double, var4: Double, var6: Int ->
