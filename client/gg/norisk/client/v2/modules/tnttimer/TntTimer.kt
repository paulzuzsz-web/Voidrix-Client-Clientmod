package gg.norisk.client.v2.modules.tnttimer
...
public object TntTimer : Module("TNT Timer", ModuleCategory.QUALITY_OF_LIFE, false, false, false, 28) {
   ...
   private final val pendingDraws: ArrayList<gg.norisk.client.v2.modules.tnttimer.TntTimer.PendingTntDraw> = ArrayList()
   ...
   private data class PendingTntDraw(pose: Matrix4f, fuse: Int) {
      ...
      public fun copy(pose: Matrix4f = this.pose, fuse: Int = this.fuse): gg.norisk.client.v2.modules.tnttimer.TntTimer.PendingTntDraw {
