...
import gg.norisk.compat.resource.NativeImagePixelsKt
...
@SourceDebugExtension(["SMAP\nArtworkCache.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ArtworkCache.kt\ngg/norisk/client/v2/modules/spotify/ArtworkCache\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n+ 3 Maps.kt\nkotlin/collections/MapsKt__MapsKt\n+ 4 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,446:1\n1#2:447\n384#3,7:448\n1999#4,14:455\n1869#4,2:469\n1869#4,2:471\n*S KotlinDebug\n*F\n+ 1 ArtworkCache.kt\ngg/norisk/client/v2/modules/spotify/ArtworkCache\n*L\n196#1:448,7\n209#1:455,14\n431#1:469,2\n438#1:471,2\n*E\n"])
public object ArtworkCache {
   ...
   private final val resolved: MutableMap<gg.norisk.client.v2.modules.spotify.ArtworkCache.Key, TextureInfo>
   private final val readyPayload: ConcurrentHashMap<gg.norisk.client.v2.modules.spotify.ArtworkCache.Key, Any> = ConcurrentHashMap()
   private final val inFlight: KeySetView<gg.norisk.client.v2.modules.spotify.ArtworkCache.Key, Boolean> = ConcurrentHashMap.newKeySet()
   ...
   private fun decodeAndPrepare(key: gg.norisk.client.v2.modules.spotify.ArtworkCache.Key): Any? {
   ...
   private fun uploadReady(key: gg.norisk.client.v2.modules.spotify.ArtworkCache.Key, payload: Any): TextureInfo? {
   ...
   private fun trimPendingPayloads(keep: gg.norisk.client.v2.modules.spotify.ArtworkCache.Key) {
   ...
   @JvmStatic
   fun {
      var var10000: java.util.Map = Collections.synchronizedMap(object : LinkedHashMap<gg.norisk.client.v2.modules.spotify.ArtworkCache.Key, TextureInfo> {
         protected override fun removeEldestEntry(eldest: MutableEntry<gg.norisk.client.v2.modules.spotify.ArtworkCache.Key, TextureInfo>): Boolean {
            if (this.size() <= 64) {
               false
            } else {
   ...
   private data class Key(url: String, radius: Int, cornerMask: Int) {
      ...
      public fun copy(url: String = this.url, radius: Int = this.radius, cornerMask: Int = this.cornerMask): gg.norisk.client.v2.modules.spotify.ArtworkCache.Key {
