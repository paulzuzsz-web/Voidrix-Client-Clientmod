...
public class TransformEditorComponent(title: String,
   ...
   private final val vector: NrcVector3f
   ...
   private final val uniformSlider: NrcSliderWithInput
   private final val axisContainer: FlowLayout
   private final val sliderContainer: FlowLayout
   private final lateinit var sliderX: NrcSliderWithInput
   private final lateinit var sliderY: NrcSliderWithInput
   private final lateinit var sliderZ: NrcSliderWithInput
   ...
   init {
      ...
      this.uniformSlider = NrcSliderWithInput(this.min, this.max, var19, var21, var23, true, 25, 20, var25, 0.55F, 0.5F)
   ...
   private fun updateVisibility() {
      ...
      if (this.expanded) {
         ...
         var var10000: NrcSliderWithInput = this.sliderX
   ...
   private fun createAxisRow(label: String, color: Color, initialValue: Float, setter: (Float) -> Unit): NrcSliderWithInput {
      ...
      val slider: NrcSliderWithInput = NrcSliderWithInput(this.min, this.max, var12, var14, var16, true, 25, 20, var18, 0.55F, 0.5F)
