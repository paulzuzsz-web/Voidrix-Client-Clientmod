...
import gg.norisk.client.v2.modules.itemmodel.ItemTransformation.Transformation
import gg.norisk.compat.client.MCRegistryKt
import gg.norisk.compat.render.ItemModelTransformHelper
...
import gg.norisk.ui.api.value.MapValue
...
public object ItemModel : Module("Item Model", ModuleCategory.QUALITY_OF_LIFE, false, true, false, 20) {
   ...
   public final var currentMode: NrcItemDisplayContext = NrcItemDisplayContext.FIRST_PERSON_RIGHT_HAND
      internal set
   ...
   private fun resolveTransform(transformation: ItemTransformation, context: NrcItemDisplayContext): Transformation? {
      val var10000: ItemTransformation.Transformation = transformation.transformations.get(context)
      if (var10000 != null) {
         return var10000
      } else {
         var var6: NrcItemDisplayContext
         when (ItemModel.WhenMappings.$EnumSwitchMapping$0[context.ordinal()]) {
            1 -> var6 = NrcItemDisplayContext.FIRST_PERSON_RIGHT_HAND
            2 -> var6 = NrcItemDisplayContext.THIRD_PERSON_RIGHT_HAND
            else -> return null
         }
   ...
   public fun transform(poseStack: PoseStack, displayContext: ItemDisplayContext, itemStack: ItemStack, leftHanded: Boolean) {
      if (INSTANCE.isEnabled()) {
         val var10000: NrcItemDisplayContext = NrcItemDisplayContext.Companion.fromMc(displayContext)
         if (var10000 != null) {
   ...
   private fun applyTransformInternal(poseStack: PoseStack, context: NrcItemDisplayContext, itemStack: ItemStack, leftHanded: Boolean) {
      ...
      if (!INSTANCE.isEnabled()) {
         ...
         if (var10000 == null) {
            ...
            if (var9 == null) {
               ...
               val var10: ItemTransformation.Transformation = var9.transformations.get(NrcItemDisplayContext.GUI)
