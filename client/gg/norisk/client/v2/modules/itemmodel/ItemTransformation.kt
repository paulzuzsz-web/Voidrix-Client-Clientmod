package gg.norisk.client.v2.modules.itemmodel

import gg.norisk.compat.render.NrcItemDisplayContext
import gg.norisk.compat.render.NrcVector3f
...
@Serializable
@SourceDebugExtension(["SMAP\nItemTransformation.kt\nKotlin\n*S Kotlin\n*F\n+ 1 ItemTransformation.kt\ngg/norisk/client/v2/modules/itemmodel/ItemTransformation\n+ 2 Maps.kt\nkotlin/collections/MapsKt__MapsKt\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,46:1\n384#2,7:47\n465#2:57\n415#2:58\n1740#3,3:54\n1252#3,4:59\n*S KotlinDebug\n*F\n+ 1 ItemTransformation.kt\ngg/norisk/client/v2/modules/itemmodel/ItemTransformation\n*L\n37#1:47,7\n43#1:57\n43#1:58\n40#1:54,3\n43#1:59,4\n*E\n"])
public data class ItemTransformation(transformations: MutableMap<
            NrcItemDisplayContext,
            gg.norisk.client.v2.modules.itemmodel.ItemTransformation.Transformation
         > = LinkedHashMap() as java.util.Map
) {
   public final var transformations: MutableMap<NrcItemDisplayContext, gg.norisk.client.v2.modules.itemmodel.ItemTransformation.Transformation>
      internal set

   @JvmField
   @JvmStatic
   private KSerializer<Object>[] $childSerializers = arrayOf(
      LinkedHashMapSerializer(NrcItemDisplayContext.Companion.serializer(), ItemTransformation.Transformation.$serializer.INSTANCE as KSerializer)
   );
   ...
   public fun getOrCreate(context: NrcItemDisplayContext): gg.norisk.client.v2.modules.itemmodel.ItemTransformation.Transformation {
   ...
   public operator fun component1(): MutableMap<NrcItemDisplayContext, gg.norisk.client.v2.modules.itemmodel.ItemTransformation.Transformation> {
      return this.transformations
   }

   public fun copy(
      transformations: MutableMap<NrcItemDisplayContext, gg.norisk.client.v2.modules.itemmodel.ItemTransformation.Transformation> = this.transformations
   ): ItemTransformation {
   ...
   @Serializable
   public data class Transformation(rotation: NrcVector3f = NrcVector3f(0.0F, 0.0F, 0.0F, 7, null),
      translation: NrcVector3f = NrcVector3f(0.0F, 0.0F, 0.0F, 7, null),
      scale: NrcVector3f = NrcVector3f(1.0F, 1.0F, 1.0F)
   ) {
      public final var rotation: NrcVector3f
         internal set

      public final var translation: NrcVector3f
         internal set

      public final var scale: NrcVector3f
         internal set
      ...
      public fun copyFrom(other: gg.norisk.client.v2.modules.itemmodel.ItemTransformation.Transformation) {
         this.rotation.copyFrom(other.rotation)
         this.translation.copyFrom(other.translation)
         this.scale.copyFrom(other.scale)
      }

      public fun copy(): gg.norisk.client.v2.modules.itemmodel.ItemTransformation.Transformation {
         return ItemTransformation.Transformation(this.rotation.copy(), this.translation.copy(), this.scale.copy())
      }

      public operator fun component1(): NrcVector3f {
         return this.rotation
      }

      public operator fun component2(): NrcVector3f {
         return this.translation
      }

      public operator fun component3(): NrcVector3f {
         return this.scale
      }

      public fun copy(rotation: NrcVector3f = this.rotation, translation: NrcVector3f = this.translation, scale: NrcVector3f = this.scale): gg.norisk.client.v2.modules.itemmodel.ItemTransformation.Transformation {
      ...
      public companion object {
         public fun serializer(): KSerializer<gg.norisk.client.v2.modules.itemmodel.ItemTransformation.Transformation> {
